                ...
                <div class="lesson_div">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="input-effect mt-2 pt-1">
                                <label>{{__('courses.Lesson')}} {{__('common.Name')}}
                                    <span>*</span><i class="fas fa-info-circle" data-toggle="tooltip" title="• The Lesson names
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-effect mt-2 pt-1">
                                <label>{{__('common.Description')}} <i class="fas fa-info-circle" data-toggle="tooltip" title="• Lesson Description
