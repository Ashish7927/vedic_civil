...
@section('mainContent')
    ...
    <link rel="stylesheet" href="{{ asset('Modules/ModuleManager/Resources/assets/sass/manage_module.css') }}?{{ $version }}">
    <link rel="stylesheet" href="{{ asset('vendor/elatih/css/parsley.css') }}?{{ $version }}">
                                        ...
                                        <td>
                                            @if(isset($config))
                                                @php
                                                    ...
                                                    echo '<br>';
                                                    echo 'Version: '.$config->$name->versions[0].' | Developed By <a href="https://elatih.com/">elatih</a>';
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 ">
                                                        <a class="primary-btn fix-gr-bg" style="white-space: nowrap;"
                                                           href="mailto:support@elatih.com">   {{__('common.Buy Now')}}</a>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('vendor/elatih/js/parsley.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('vendor/elatih/js/function.js') }}"></script>
    <script type="text/javascript" src="{{ asset('vendor/elatih/js/common.js') }}"></script>
