...
class EmailTemplateForMeetingApproveMail extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $template = \Modules\SystemSetting\Entities\EmailTemplate::where('act', 'send_meeting_approve_mail')->first();

        if (!$template) {
            $template = new \Modules\SystemSetting\Entities\EmailTemplate();
            $template->act = 'send_meeting_approve_mail';
        }

        $shortCode = '{"meeting_id": "Meeting ID", "topic": "Topic", "date": "Date"}';
        $subject = 'Your BBB Meeting Approved By Admin';
        $br = "<br/>";
        ...
        $html = '
            ...
            <div class="">
                ...
                <div style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; padding: 20px;">
                    ...
                    <p style="color: rgb(85, 85, 85);">Your BBB Meeting Approved By Admin</p>
                </div>
