...
@section('table')
    @php $table_name = 'withdraws'; @endphp
    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>{{ __('Public Monthly Statement Reports') }}</h1>

                <div class="bc-pages">
                    <a href="{{ url('/dashboard') }}">{{ __('common.Dashboard') }} </a>
                    <a href="#">{{ __('quiz.Report') }} </a>
                    <a href="#">{{ __('Content Provider Monthly Payment Reports') }}</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white_box mb_30">
                        ...
                        <form action="{{ route('admin.cp_export_monthly_statement_report') }}" method="POST" id="filter-form">
                            @csrf
                            ...
                            <div class="search_course_btn text-right">
                                <button type="button" class="apply-filter-dates primary-btn radius_30px mr-10 fix-gr-bg">
                                    {{ __('courses.Filter') }}
                                </button>

                                <button type="button" id="reset-filters" class="primary-btn radius_30px mr-10 fix-gr-bg">
                                    {{ __('Reset') }}
                                </button>
                            </div>
                        </form>
                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"> {{ __('Public Monthly Statement Reports') }} </h3>
                            <ul class="d-flex">
                                <li>
                                    <a class="primary-btn radius_30px mr-10 fix-gr-bg" id="excel_export_table_data" href="javascript:void(0)">
                                        Export
                                    </a>
                                </li>
                            </ul>
                            ...
                            <table id="lms_table" class="table Crm_table_active3">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('common.Product Type') }}</th>
                                        ...
                                        <th scope="col">{{ __('common.HRDCORP + SST OF TOTAL SALES') }} ({{ Settings('hrdc_commission') }}%)</th>
...
@push('scripts')
    @php $url = route('admin.getCpMonthlyStatementReports'); @endphp
    ...
    <script>
        ...
        $('#excel_export_table_data').click(function () {
