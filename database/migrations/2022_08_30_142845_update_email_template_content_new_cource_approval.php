...
class UpdateEmailTemplateContentNewCourceApproval extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $shortCode = '{"cp_name":"Content Provider/Partner Name", "course":"Course Name", "course_link":"Course Link"}';
    ...
    public function htmlPart($subject, $body)
    {
        $html = '
                ...
                <p style="color: rgb(85, 85, 85);">Hi <b>' . $body['cp_name'] . '</b>,</p>
                <p style="color: rgb(85, 85, 85);"><br></p>
                <p style="color: rgb(85, 85, 85);">The following course has been published.</p></div>
                    <p style="color: rgb(85, 85, 85);"> Course Title : <b>' . $body['course'] . '</b></p>
                </div>
                    <p style="color: rgb(85, 85, 85);"> Course Link : <a href="{{course_link}}">' . $body['course_link'] . '</a></p>
                </div>
                </div>
