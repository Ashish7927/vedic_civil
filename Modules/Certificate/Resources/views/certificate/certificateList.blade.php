            ...
            <table id="lms_table" class="table Crm_table_active3">
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ __('certificate.Is Partner') }}</th>
                ...
                <tbody>
                    @foreach ($certificates as $key => $certificate)
                        <tr>
                            ...
                            <td>{{ $certificate->is_partner == 1 ? 'Yes' : 'No' }}</td>
                            <td>
                        ...
                        <div class="modal fade admin-query" id="certificate_delete{{ $certificate->id }}">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">{{ __('common.Delete') }}
                                            {{ __('certificate.Certificate') }}</h4>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mt-40 d-flex justify-content-between">
                                            ...
                                            {{ Form::open(['route' => ['certificate.destroy', $certificate->id], 'method' => 'DELETE', 'enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="modal fade admin-query" id="course_certificate{{ $certificate->id }}">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mt-40 d-flex justify-content-between">
                                            <button type="button" class="primary-btn tr-bg"
                                                data-dismiss="modal">{{ __('common.Cancel') }}</button>
                                            {{ Form::open(['route' => ['course.certificate.update', $certificate->id], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                                            <button class="primary-btn fix-gr-bg"
                        ...
                        <div class="modal fade admin-query" id="quiz_certificate{{ $certificate->id }}">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mt-40 d-flex justify-content-between">
                                            <button type="button" class="primary-btn tr-bg"
                                                data-dismiss="modal">{{ __('common.Cancel') }}</button>
                                            {{ Form::open(['route' => ['quiz.certificate.update', $certificate->id], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                                            <button class="primary-btn fix-gr-bg"
                                                type="submit">{{ __('certificate.Make Default') }}</button>
                                            {{ Form::close() }}
                                        </div>
                        ...
                        <div class="modal fade admin-query" id="class_certificate{{ $certificate->id }}">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mt-40 d-flex justify-content-between">
                                            <button type="button" class="primary-btn tr-bg"
                                                data-dismiss="modal">{{ __('common.Cancel') }}</button>
                                            {{ Form::open(['route' => ['class.certificate.update', $certificate->id], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                                            <button class="primary-btn fix-gr-bg"
                                                type="submit">{{ __('certificate.Make Default') }}</button>
                                            {{ Form::close() }}
                                        </div>
