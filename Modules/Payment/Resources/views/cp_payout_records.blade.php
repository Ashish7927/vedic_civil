            ...
            <div class="container-fluid">
                <div class="row justify-content-between">
                    ...
                    <div class="bc-pages">
                        <a href="{{url('/dashboard')}}">{{__('common.Dashboard')}} </a>
                        <a href="#">{{__('quiz.Report')}} </a>
                        <a href="#">{{__('Content Provider Payout Records')}}</a>
                    </div>
                </div>
            </div>
                ...
                <div class="QA_table ">
                    ...
                    <table id="lms_table" class="table Crm_table_active3">
                        ...
                        <tr>
                            ...
                            <th scope="col">{{__('common.CP Name')}}</th>
                            <th scope="col">{{__('common.Payable Amount To CP')}}</th>
                            <th scope="col">{{__('withdraw.Payment Status')}}</th>
                            <th scope="col">{{__('common.Action Update Payout Status To Paid')}}</th>
                            @if(\Illuminate\Support\Facades\Auth::user()->role_id==1)
...
@push('scripts')
    ...
    if (isset($_GET['year'])){
        ...
        $year ='';
            ...
            $url =route('admin.getCpPayoutRecordsData').'?instructor='.$instructor.'&month='.$month.'&year='.$year;
    @endphp
    ...
    <script>
        ...
        let table = $('#lms_table').DataTable({
            ...
            columns: [
                ...
                // {data: 'purchaseid', name: 'purchaseid', orderable: false},
