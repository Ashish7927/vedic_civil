                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <select class="form-control select2 select2_ajax" name="coupon_user_id" id="coupon_user_id">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        userload = () => {
            var url = "{{ route('user_data_with_ajax_select2', 3) }}";
            $("#coupon_user_id").select2({
                allowClear: true,
                ajax: {
                    url: url,
                    dataType: 'json',
