                                        ...
                                        <form action="{{route('frontend.sliders.store') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                            ...
                                                            <small>({{__('common.Recommended Size')}} 1366x615)</small>
                                                        </label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{__('frontendmanage.Mobile')}} {{__('frontendmanage.Image')}}
                                                            <small>({{__('common.Recommended Size')}} 750x375)</small>
                                                        </label>
                                                        <div class="primary_file_uploader">
                                                            <input class="primary-input filePlaceholder" type="text"
                                                                   placeholder="{{isset($slider) && $slider->mobile_image ? showPicName($slider->mobile_image) :__('virtual-class.Browse Image file')}}"
                                                                   readonly="" {{ $errors->has('mobile_image') ? ' autofocus' : '' }}>
                                                            <button class="" type="button">
                                                                <label class="primary-btn small fix-gr-bg"
                                                                       for="document_file1_mobile">{{__('common.Browse')}}</label>
                                                                <input type="file"
                                                                       class="d-none fileUpload" name="mobile_image"
                                                                       id="document_file1_mobile">
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                       for="image_as_link1">
                                                                    <input type="radio"
                                                                           class="common-radio image_as_link_inpt"
                                                                           id="image_as_link1"
                                                                           name="image_as_link"
                                                                           {{isset($slider)?$slider->image_as_link==1?'checked':'':'checked'}}
                                                                           value="1">
                                                            ...
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                    ...
                                                                    <input type="radio"
                                                                           ...
                                                                           id="image_as_link2"
                                                                           name="image_as_link"
                                                                           {{isset($slider)?$slider->image_as_link==0?'checked':'':''}}
                                                                           value="0">
                                                ...
                                                <div class="col-lg-12" id="link_div">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">Link</label>
                                                        <input name="link" id="link"
                                                               class="primary_input_field name {{ @$errors->has('link') ? ' is-invalid' : '' }}"
                                                               placeholder="Link"
                                                               type="text"
                                                               value="{{isset($slider)?$slider->link:old('link')}}" {{$errors->has('link') ? 'autofocus' : ''}}>
                                                        @if ($errors->has('link'))
                                                            <span class="invalid-feedback d-block mb-10" role="alert">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                       for="open_in_new1">
                                                                    <input type="radio"
                                                                           class="common-radio open_in_new_inpt"
                                                                           id="open_in_new1"
                                                                           name="open_in_new"
                                                                           {{isset($slider)?$slider->open_in_new==1?'checked':'':'checked'}}
                                                                           value="1">
                                                                    <span class="checkmark mr-2"></span> Yes
                                                                </label>
                                                            </div>
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                    ...
                                                                    <input type="radio"
                                                                           ...
                                                                           id="open_in_new2"
                                                                           name="open_in_new"
                                                                           {{isset($slider)?$slider->open_in_new==0?'checked':'':''}}
                                                                           value="0">
                                                                    <span class="checkmark mr-2"></span> No
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                       for="show_title1">
                                                                    <input type="radio"
                                                                           class="common-radio show_title_inpt"
                                                                           id="show_title1"
                                                                           name="show_title"
                                                                           {{isset($slider)?$slider->show_title==1?'checked':'':'checked'}}
                                                                           value="1">
                                                                    <span class="checkmark mr-2"></span> Yes
                                                                </label>
                                                            </div>
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                    ...
                                                                    <input type="radio"
                                                                           ...
                                                                           id="show_title2"
                                                                           name="show_title"
                                                                           {{isset($slider)?$slider->show_title==0?'checked':'':''}}
                                                                           value="0">
                                                                    <span class="checkmark mr-2"></span> No
                                                                </label>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                       for="show_subtitle1">
                                                                    <input type="radio"
                                                                           class="common-radio show_subtitle_inpt"
                                                                           id="show_subtitle1"
                                                                           name="show_subtitle"
                                                                           {{isset($slider)?$slider->show_subtitle==1?'checked':'':'checked'}}
                                                                           value="1">
                                                                    <span class="checkmark mr-2"></span> Yes
                                                                </label>
                                                            </div>
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                    ...
                                                                    <input type="radio"
                                                                           ...
                                                                           id="show_subtitle2"
                                                                           name="show_subtitle"
                                                                           {{isset($slider)?$slider->show_subtitle==0?'checked':'':''}}
                                                                           value="0">
                                                                    <span class="checkmark mr-2"></span> No
                                                                </label>
                                                            </div>
                                                ...
                                                <div class="col-lg-12" id="link_div">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">Priority Order</label>
                                                        <input name="order" id="order"
                                                               class="primary_input_field name {{ @$errors->has('order') ? ' is-invalid' : '' }}"
                                                               placeholder="Priority Order"
                                                               type="text"
                                                               value="{{isset($slider)?$slider->order:($sliders->count() + 1)}}" {{$errors->has('order') ? 'autofocus' : ''}}>
                                                        @if ($errors->has('order'))
                                                            <span class="invalid-feedback d-block mb-10" role="alert">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                       for="show_searchbar1">
                                                                    <input type="radio"
                                                                           class="common-radio show_searchbar_inpt"
                                                                           id="show_searchbar1"
                                                                           name="show_searchbar"
                                                                           {{isset($slider)?$slider->show_searchbar==1?'checked':'':'checked'}}
                                                                           value="1">
                                                                    <span class="checkmark mr-2"></span> Yes
                                                                </label>
                                                            </div>
                                                            <div class="col-md-4 mb-25">
                                                                <label class="primary_checkbox d-flex mr-12 "
                                                                    ...
                                                                    <input type="radio"
                                                                           ...
                                                                           id="show_searchbar"
                                                                           name="show_searchbar"
                                                                           {{isset($slider)?$slider->show_searchbar==0?'checked':'':''}}
                                                                           value="0">
                                                                    <span class="checkmark mr-2"></span> No
                                                                </label>
                                                            </div>
                            ...
                            <div class="">
                                <table id="lms_table" class="table Crm_table_active3">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('frontendmanage.Mobile') }} {{ __('common.Image') }}</th>
                                    ...
                                    @foreach($sliders as $key => $slider)
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <img style="max-width: 100px" src="{{asset(@$slider->mobile_image)}}"
                                                         alt=""
                                                         class="img img-responsive m-2">
                                                </div>
                                            </td>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            var image_as_link_value = $("input[name='image_as_link']:checked").val();
            if (image_as_link_value == 0) {
                $('#link').val('');
                $('#link_div').hide();
            } else {
                $('#link_div').show();
        ...
        $("input[name='image_as_link']").change(function () {
            var value = $("input[name='image_as_link']:checked").val();
            if (value == 0) {
                $('#link').val('');
                $('#link_div').hide();
            } else {
