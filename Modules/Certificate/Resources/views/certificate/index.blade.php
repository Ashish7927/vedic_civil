...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('backend/css/certificate.css') }}?{{ $version }}">
@endpush
@section('mainContent')
...
@push('scripts')
    <script src="{{ asset('/') }}/Modules/CourseSetting/Resources/assets/js/course.js?{{ $version }}"></script>
    <script src="{{ asset('backend/js/certificate.js') }}?{{ $version }}"></script>
    <script src="{{ asset('js/html2pdf.bundle.js') }}?{{ $version }}"></script>
@endpush
