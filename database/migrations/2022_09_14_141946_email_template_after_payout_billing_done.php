...
class EmailTemplateAfterPayoutBillingDone extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $shortCode = '{"instructor_name": "Instructor Name","amount": "Amount","issue_date": "Issue Date"}';
        ...
        $html = '
            ...
            <div class="">
                ...
                <div style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; padding: 20px;">
                    ...
                    <p style="color: rgb(85, 85, 85);">A new Payout has successfully created</p>
                </div>

                <p style="color: rgb(85, 85, 85);"> Instructor Name : <b>' . $body['instructor_name'] . '</b></p>
