...
class CategorySeederTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Category::insert([
            ...
            'position_order' => 2,
            'image' => 'demo/category/image/' . '1.' . 'png',
            'thumbnail' => 'demo/category/thumb/' . '1.' . 'png',
        ...
        Category::insert([
            ...
            'description' => 'Laboris Nam laborum voluptatibus dolor aspernatur laboriosam commodo in voluptatem Temporibus eum',
            'position_order' => 2,
            'image' => 'demo/category/image/' . '2.' . 'png',
            'thumbnail' => 'demo/category/thumb/' . '2.' . 'png',
            'url' => 'https://youtu.be/bG9eMa_025c',
            'updated_at' => Carbon::now(),
            'created_at' => Carbon::now(),
        ]);
        ...
        Category::insert([
            ...
            'description' => 'Laboris Nam laborum voluptatibus dolor aspernatur laboriosam commodo in voluptatem Temporibus eum',
            'position_order' => 3,
            'image' => 'demo/category/image/' . '3.' . 'png',
            'thumbnail' => 'demo/category/thumb/' . '3.' . 'png',
            'url' => 'https://youtu.be/bG9eMa_025c',
            'updated_at' => Carbon::now(),
            'created_at' => Carbon::now(),
        ]);
        ...
        Category::insert([
            ...
            'description' => 'Laboris Nam laborum voluptatibus dolor aspernatur laboriosam commodo in voluptatem Temporibus eum',
            'position_order' => 4,
            'image' => 'demo/category/image/' . '4.' . 'png',
            'thumbnail' => 'demo/category/thumb/' . '4.' . 'png',
            'url' => 'https://youtu.be/bG9eMa_025c',
            'updated_at' => Carbon::now(),
            'created_at' => Carbon::now(),
        ]);
        ...
        Category::insert([
            ...
            'description' => 'Laboris Nam laborum voluptatibus dolor aspernatur laboriosam commodo in voluptatem Temporibus eum',
            'position_order' => 5,
            'image' => 'demo/category/image/' . '5.' . 'png',
            'thumbnail' => 'demo/category/thumb/' . '5.' . 'png',
            'url' => 'https://youtu.be/bG9eMa_025c',
            'updated_at' => Carbon::now(),
            'created_at' => Carbon::now(),
        ]);
