...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        'name', 'role_id', 'username', 'gender', 'email', 'phone', 'password', 'email_verified_at', 'mobile_verified_at', 'avatar', 'subscribe', 'dob', 'citizenship', 'race', 'employment_status', 'job_designation', 'sector', 'business_nature', 'business_nature_other', 'not_working', 'highest_academic', 'current_residing','phone'
    ];
    ...
    {
        return $this->hasOne(CorporateAdmin::class, 'corporate_admin_id');
    }
}
