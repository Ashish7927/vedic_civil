...
mix
    ...
    .sass('resources/sass/backend/app.scss', 'backend/css/app.css')
    .sass('resources/sass/backend/backend_style.scss', 'backend/css/backend_style.css')
    .sass('resources/sass/backend/backend_style_rtl.scss', 'backend/css/backend_style_rtl.css')
    .combine([
        ...
        'backend/js/summernote-bs4.min.js',
...
], 'frontend/elatihlmstheme/js/app.js')
    .sass('resources/sass/frontend/default/app.scss', 'frontend/elatihlmstheme/css/app.css')
    .sass('resources/sass/frontend/default/frontend_style.scss', 'frontend/elatihlmstheme/css/frontend_style.css')
;

mix.js('resources/js/chat.js', 'js/app.js');
