...
class InsertAssignCourseEmailTemplate extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $template = EmailTemplate::where('act', 'assign_course')->first();
        if (!$template) {
            $template = new EmailTemplate();
            $template->act = 'assign_course';
        }
    ...
    public function htmlPart($subject, $body)
    {
        $html = '
            ...
            <p style="color: rgb(85, 85, 85);">A new Course has been assigned to you. For more information, please login to e-LATiH.</p></div>
