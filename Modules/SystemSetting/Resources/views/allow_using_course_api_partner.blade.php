        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="#">Partner</a>
                    <a href="#">Allow Using Api Partner {{__('common.List')}}</a>
                </div>
            </div>
        </div>
    </section>
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">Allow Using Api Partner {{__('common.List')}}</h3>
                        </div>
                ...
                <div class="modal fade admin-query" id="declineInstructorCourseApi">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <form action="{{route('instructor.decline_course_api_key')}}" method="POST">
                                @csrf
...
@push('scripts')
    ...
    @php
        $url = route('allow_using_course_api_partners_data');
    @endphp
    ...
    <script>
        ...
        $(document).on('click', '.declinedInstructorCourseApi', function () {
            let id = $(this).data('id');
            $('#instructorCourseApiKeyId').val(id);
            $("#declineInstructorCourseApi").modal('show');
        });
    </script>
