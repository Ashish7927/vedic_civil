...
class StudentImportController extends Controller
{
    ...
    public function LearnerListExcelDownload(Request $request)
    {
        return Excel::download(new LearnerExport($request->name, $request->email, $request->phone, $request->start_date, $request->end_date, $request->country, $request->citizenship, $request->identification_number, $request->job_designation, $request->sector, $request->not_working, $request->business_nature, $request->business_nature_other, $request->zip, $request->gender, $request->dob, $request->race, $request->employment_status, $request->highest_academic, $request->current_residing), 'learner-list.xlsx');
    }
}
