...
class QuizPageSection extends Component
{
    ...
    public function render()
    {
        ...
        return view(theme('components.quiz-page-section'), compact('levels', 'order', 'category', 'level', 'order', 'language', 'type', 'total', 'courses','mode', 'rate', 'duration', 'content_provider', 'startprice', 'endprice', 'startDuration', 'endDuration', 'cpdata', 'version'));
    }
}
