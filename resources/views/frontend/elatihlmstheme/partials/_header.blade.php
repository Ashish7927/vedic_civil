...
<!-- Google / Search Engine Tags -->
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/elatihlmstheme') }}/css/fontawesome.css?{{ $version }}">
    <link rel="stylesheet" href="{{ asset('public/backend/css/themify-icons.css') }}?{{ $version }}"/>
    <link rel="stylesheet" href="{{ asset('public/frontend/elatihlmstheme') }}/css/flaticon.css?{{ $version }}">
    <link rel="stylesheet" href="{{ asset('public/frontend/elatihlmstheme') }}/css/nice-select.css?{{ $version }}">
    <link rel="stylesheet" href="{{ asset('public/frontend/elatihlmstheme') }}/css/notification.css?{{ $version }}">
    ...
    @if (str_contains(request()->url(), 'chat'))
        <link rel="stylesheet" href="{{asset('public/backend/css/jquery-ui.css')}}?{{ $version }}"/>
        <link rel="stylesheet" href="{{asset('public/backend/vendors/select2/select2.css')}}?{{ $version }}"/>
        <link rel="stylesheet" href="{{asset('public/chat/css/style-student.css')}}?{{ $version }}">
    @endif

    @if (auth()->check() && auth()->user()->role_id == 3 && !str_contains(request()->url(), 'chat'))
        <link rel="stylesheet" href="{{asset('public/chat/css/notification.css')}}?{{ $version }}">
    @endif

    @if (isModuleActive("WhatsappSupport"))
        <link rel="stylesheet" href="{{ asset('public/whatsapp-support/style.css') }}?{{ $version }}">
    @endif
    <script>
        window.Laravel = {
            "baseUrl": '{{ url('/') }}' + '/',
