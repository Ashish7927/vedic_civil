...
@section('title'){{Settings('site_title')  ? Settings('site_title')  : 'e-Latih LMS'}} |  {{$course->title}} @endsection
...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/elatihlmstheme/css/class_details.css')}}"/>
    <link rel="stylesheet" href="{{asset('public/frontend/elatihlmstheme/css/quiz_details.css')}}"/>
@endsection
...
@section('js')
    ...
    <script src="{{ asset('public/frontend/elatihlmstheme/js/quiz_details.js') }}"></script>
