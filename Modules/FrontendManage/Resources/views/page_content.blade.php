                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @endif
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="">{{ __('forum.Forum Page Banner') }}  <small>({{__('common.Recommended Size')}} 1366x615)</small>
                                                            </label>
                                                            <div class="primary_file_uploader">
                                                                <input
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Corporate Access Page Title') }}</label>
                                                        <input class="primary_input_field"
                                                               placeholder="{{ __('frontendmanage.Corporate Access Page Title') }}"
                                                               type="text" name="corporate_access_page_title"
                                                               {{ $errors->has('corporate_access_page_title') ? ' autofocus' : '' }}
                                                               value="{{isset($page_content)? $page_content->corporate_access_page_title : ''}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Corporate Access Page Sub Title') }}</label>
                                                        <input class="primary_input_field"
                                                               placeholder="{{ __('frontendmanage.Corporate Access Page Sub Title') }}"
                                                               type="text" name="corporate_access_page_sub_title"
                                                               {{ $errors->has('corporate_access_page_sub_title') ? ' autofocus' : '' }}
                                                               value="{{isset($page_content)? $page_content->corporate_access_page_sub_title : ''}}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2">
                                                    <div class="primary_input mb-25">
                                                        <img class=" imagePreview12" style="max-width: 100%"
                                                             src="{{asset('/'.$page_content->corporate_access_page_banner)}}"
                                                             alt="">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label"
                                                               for="">{{ __('frontendmanage.Corporate Access Page Banner') }}
                                                            <small>({{__('common.Recommended Size')}} 1366x615)</small>
                                                        </label>
                                                        <div class="primary_file_uploader">
                                                            <input
                                                                class="primary-input  filePlaceholder {{ @$errors->has('corporate_access_page_banner') ? ' is-invalid' : '' }}"
                                                                type="text" id=""
                                                                placeholder="Browse file"
                                                                readonly="" {{ $errors->has('corporate_access_page_banner') ? ' autofocus' : '' }}>
                                                            <button class="" type="button">
                                                                <label class="primary-btn small fix-gr-bg"
                                                                       for="file12">{{ __('common.Browse') }}</label>
                                                                <input type="file" class="d-none imgInput12"
                                                                       name="corporate_access_page_banner" id="file12">
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
