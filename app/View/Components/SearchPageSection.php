...
class SearchPageSection extends Component
{
    ...
    public function render()
    {
        ...
        return view(theme('components.search-page-section'), compact('cat', 'levels', 'search', 'order', 'mode', 'category', 'level', 'order', 'language', 'type', 'total', 'courses', 'rate', 'duration', 'content_provider', 'startprice', 'endprice', 'startDuration', 'endDuration', 'cpdata', 'version'));
    }
}
