...
class UpdateEamilTemplateRejectWithFeedback extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $shortCode = '{"course":"Course Name","comment":"Comment","course_link":"Course Link"}';
    ...
    public function htmlPart($subject, $body)
    {
        $html = '
            ...
            <p style="color: rgb(85, 85, 85);"><br></p>
            <p style="color: rgb(85, 85, 85);"> Course : <a href="{{course_link}}">' . $body['course_link'] . '</a></p></div>
            </div>
