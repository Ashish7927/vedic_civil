@extends('frontend.elatihlmstheme.auth.layouts.app')
@section('content')
    ...
    <style>
		...
		.dashboardbtn{background: #212f64;}
    </style>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-12">
                    <div class="error_wrapper_info text-center">
                        <div class="thumb">
                            <img src="{{asset('/public/elatihlmstheme/')}}/img/banner/error_thumb.png" alt="">
                        </div>
                        ...
                        <form method="POST" class="" action="{{ route('verification_mail_resend') }}">
                            ...
                            <div class="">
								...
								<a href="{{route('studentDashboard')}}" class="theme_btn dashboardbtn">
                                    Go To {{__('common.Dashboard')}}
                                </a>	
