...
@section('content')
    ...
    <style>
        ...
        .blue-intro{color:#337ab7!important;}
                    ...
                    <div class="row">
                        <ul id="progressbar">
                            <li class="active" id="account">
                                <strong>{{__('common.Account Information')}}</strong>
                            </li>

                            <li id="personal">
                                <strong>{{__('common.Personal Information')}}</strong>
                            </li>
                        </ul>
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="col-12">
                                    <div class="input-group custom_group_field">
                                        <input type="text" class="form-control pl-0" placeholder="{{__('student.Enter Full Name')}} {{ $custom_field->required_company ? '*' : ''}}" {{ $custom_field->required_name ? '' : ''}} aria-label="Username" name="name" value="{{ $register->name ?? old('name') }}">
                                    </div>
                                ...
                                <div class="col-12 mt_20">
                                    <div class="input-group custom_group_field">
                                        <input type="email" class="form-control pl-0" placeholder="{{__('common.Enter Email')}} *" aria-label="email" name="email" value="{{ $register->email ?? old('email') }}" autocomplete="off">
                                    </div>
                                ...
                                <div class="col-12 mt_20">
                                    <div class="input-group custom_group_field">
                                        <input type="email" class="form-control pl-0" placeholder="{{__('common.confirm_email')}} *" aria-label="email_confirmation" name="email_confirmation" value="{{ $register->email ?? '' }}" autocomplete="off">
                                    </div>
                                ...
                                <div class="col-12 mt_20">
                                    <div class="input-group custom_group_field" style="border-bottom: 2px solid #203369;">
                                        <input type="password" class="form-control pl-0" id="password" placeholder="{{__('frontend.Enter Password')}} *" aria-label="password" name="password" value="{{ $register->password ?? '' }}" autocomplete="off" style="max-width: 96%; border-bottom: none;" data-toggle="tooltip" title="{{__('frontend.Minimum 8 characters including 1 capital letters and 1 unique symbol')}}">
                                ...
                                <div class="col-12 mt_20">
                                    <div class="input-group custom_group_field" style="border-bottom: 2px solid #203369;">
                                        <input type="password" class="form-control pl-0" id="c_password" placeholder="{{__('common.Enter Confirm Password')}} *" name="password_confirmation" aria-label="password_confirmation" value="{{ $register->password ?? '' }}" autocomplete="off" style="max-width: 96%;border-bottom: none;">

                                        <img src="{{ asset('images/eye.png') }}" class="hide_show_conf_pass" style="max-height: 13px; margin-top: 14px;">
                                    </div>
                                ...
                                <div class="col-12 mt_20">
                                    <div class="remember_forgot_passs d-flex align-items-center">
                                        <label class="primary_checkbox d-flex" for="checkbox">
                                            ...
                                            <p>I have read and agree to e-LATiH <a href="{{asset('pages/privacy-policy-and-cookie-policy')}}" target="_blank" style="color: var(--system_primery_color) !important;">Privacy Policy</a> and <a href="{{asset('pages/terms-of-use')}}" target="_blank" style="color: var(--system_primery_color) !important;">Terms of Use</a>.</p>
                                        </label>
                            ...
                            <input type="submit" name="next" class="action-button" id="btn_continue" value="Continue" />
                        </fieldset>
                    </div>
                </form>
