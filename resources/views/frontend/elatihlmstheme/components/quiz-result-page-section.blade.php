                        ...
                        <div class="col-12">
                            ...
                            <div class="quiz_score_wrapper mb_30">
                                ...
                                <div class="quiz_test_body">
                                    @if( isset($quiz->quiz->display_result_message) && $quiz->quiz->display_result_message == 0)
                                        @if($result['status'] == 'Failed')
                                            <h3>{{$quiz->quiz->fail_message}}</h3>
                                        @else
                                            <h3>{{$quiz->quiz->pass_message}}</h3>
                                        @endif
                                    @else 
                                        <h3>{{__('student.Congratulations! You’ve completed')}} {{$quiz->quiz->title}}</h3>
                                    @endif
