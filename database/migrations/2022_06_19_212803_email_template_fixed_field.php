...
class EmailTemplateFixedField extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function htmlPart($subject, $body)
    {
        $html = '
            ...
            <img src="'. $body['url'] .'/public/uploads/editor-image/e-LATiH Logo__Main logo (Reverse Colour).png1643194197.png" style="position: relative;top: 20px;" />
            ' . $subject . '
