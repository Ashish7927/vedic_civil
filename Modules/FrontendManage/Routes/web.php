...
use App\Http\Controllers\ApiDevelopmentSetupController;
...
//sliders
    ...
    Route::get('logo-companies', 'FrontendManageController@logoCompanies')->name('logoCompanies');
    Route::post('logo-companies', 'FrontendManageController@logoCompanies')->name('logoCompanies_Update');
    ...
    /* Home Content Featured Course start*/
    Route::post('/add-featuredcourse', 'FrontendManageController@addFeaturedCourse')->name('addFeaturedCourse');
    Route::post('/edit-featuredcourse', 'FrontendManageController@editFeaturedCourseElement')->name('editFeaturedCourseElement');
    Route::post('/reordering-featuredcourse', 'FrontendManageController@reorderingFeaturedCourse')->name('reorderingFeaturedCourse');
    Route::post('/delete-featuredcourse', 'FrontendManageController@deleteFeaturedCourse')->name('deleteFeaturedCourse');
    /* Home Content Featured Course end*/

    /* Corporate Access Page - content provider start*/
    Route::get('corporate-access-page-content', 'CorporateAccessPageController@index')->name('corporateAccessPageContent');
    Route::post('corporate-access-page-content', 'CorporateAccessPageController@CorporateAccessPageContentUpdate')->name('corporateAccessPageContentUpdate');
    Route::post('/add-content-provider', 'CorporateAccessPageController@addContentProvider')->name('addContentProvider');
    Route::post('/edit-content-provider', 'CorporateAccessPageController@editContentProviderElement')->name('editContentProviderElement');
    Route::post('/reordering-content-provider', 'CorporateAccessPageController@reorderingContentProvider')->name('reorderingContentProvider');
    Route::post('/delete-content-provider', 'CorporateAccessPageController@deleteContentProvider')->name('deleteContentProvider');
    /* Corporate Access Page - content provider end*/

    /* Corporate Access Page Content - Corporate start*/
    Route::post('/add-corporate', 'CorporateAccessPageController@addCorporate')->name('addCorporate');
    Route::post('/edit-corporate', 'CorporateAccessPageController@editCorporateElement')->name('editCorporateElement');
    Route::post('/reordering-corporate', 'CorporateAccessPageController@reorderingCorporate')->name('reorderingCorporate');
    Route::post('/delete-corporate', 'CorporateAccessPageController@deleteCorporate')->name('deleteCorporate');
    /* Corporate Access Page Content - Corporate  end*/

    //Page Builder
    Route::resource('page', 'FrontPageController');
    Route::resource('logo-companies', 'LogoCompaniesController');
    ...
    Route::get('/smeCourses', 'SmeCoursesController@index')->name('smeCourses')->middleware('RoutePermissionCheck:smeCourses');
    Route::post('/save-smeCourses', 'SmeCoursesController@store')->name('smeCourses.store')->middleware('RoutePermissionCheck:smeCourses');

    Route::get('/coursesApiDevelopment', 'ApiDevelopmentSetupController@index')->name('coursesApiDevelopment')->middleware('RoutePermissionCheck:coursesApiDevelopment');
    Route::post('/save-course-api-development', 'ApiDevelopmentSetupController@store')->name('coursesApiDevelopment.store')->middleware('RoutePermissionCheck:coursesApiDevelopment');
