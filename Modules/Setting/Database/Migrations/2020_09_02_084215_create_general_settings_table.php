...
class CreateGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('general_settings', function (Blueprint $table) {
            $table->id();
            $table->string('site_title')->nullable()->default('e-Latih LMS');
        ...
        DB::table('general_settings')->insert([
            [
                'id' => 1,
                'site_title' => 'e-Latih LMS',
                'address' => '89/2 Panthapath, Dhaka 1215, Bangladesh',
                'phone' => '+8801841412141',
                'email' => 'info@elatih.com',
                'logo' => 'uploads/settings/logo.png',
                'logo2' => 'uploads/settings/logo.png',
                'favicon' => 'uploads/settings/favicon.png',
                'system_version' => '4.0.0',
                'zip_code' => '1205',
                'active_status' => '1',
                'copyright_text' => 'Copyright © 2021 InfixLMS. All rights reserved | Made By CodeThemes ',
                'footer_copy_right' => 'Copyright © 2021 InfixLMS. All rights reserved | Made By  <a href="https://elatih.com" target="_blank"><span style="color:#D12053">CodeThemes</span></a>',
