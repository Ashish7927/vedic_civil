...
class AddSubmissionDateToEmailTemplate extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $shortCode = '{"course":"Cource Name","company_name": "Company Name","course_type":"Course Type","course_submission_date" : "Course Submission Date"}';
        $subject = 'New Cource';
        $br = "<br/>";
        $body['course'] = "{{course}}";
        $body['footer'] = "{{footer}}";
    ...
    public function htmlPart($subject, $body)
    {
        $html = '
                ...
                <p style="color: rgb(85, 85, 85);"> Course <b>' . $body['course'] . '</b> created successfully.</p></div>
                <p style="color: rgb(85, 85, 85);"> Company <b>' . $body['company_name'] . '</b></p></div>
                <p style="color: rgb(85, 85, 85);"> Type <b>' . $body['course_type'] . '</b></p></div>
                <p style="color: rgb(85, 85, 85);"> Submission Date <b>' . $body['course_submission_date'] . '</b></p></div>
                </div>
