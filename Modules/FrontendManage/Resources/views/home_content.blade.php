                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <input class="primary_input_field"
                                                                               ...
                                                                               {{ $errors->has('best_category_title') ? ' autofocus' : '' }}
                                                ...
                                                @elseif($block->id==5)
                                                    <div data-id="{{$block->id}}" class="row">
                                                        ...
                                                        <div id="show_course_section_box" class="col-md-12"
                                                            ...
                                                            <div class="row mb-25">
                                                                <div class="col-xl-12">
                                                                    <label class="primary_input_label font-weight-bold">Top Online Courses</label>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label"
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <input class="primary_input_field"
                                                                               ...
                                                                               {{ $errors->has('course_sub_title') ? ' autofocus' : '' }}
                                                        ...
                                                        <div class="col-xl-12 ">
                                                            <div class="mb_25">
                                                                <label class="switch_toggle "
                                                                       for="show_featured_course_section">
                                                                    <input type="checkbox" class="status_enable_disable"
                                                                           name="show_featured_course_section"
                                                                           id="show_featured_course_section"
                                                                           @if (@$home_content->show_featured_course_section == 1) checked
                                                                           @endif value="1">
                                                                    <i class="slider round"></i>
                                                                </label>
                                                                {{__('frontendmanage.Featured Course Section Show In Homepage')}}
                                                            </div>
                                                        </div>
                                                        <div id="show_featured_course_section_box" class="col-md-12"
                                                             style="@if (@$home_content->show_featured_course_section == 0) display:none
                                                             @endif ">
                                                            <div class="row mb-25">
                                                                <div class="col-xl-12">
                                                                    <label class="primary_input_label font-weight-bold">Featured Courses</label>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label"
                                                                        ...
                                                                        <input class="primary_input_field"
                                                                               placeholder="{{ __('frontendmanage.Course Title') }}"
                                                                               type="text" name="course_title_1"
                                                                               {{ $errors->has('course_title_1') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->course_title_1 : ''}}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <input class="primary_input_field"
                                                                               placeholder="{{ __('frontendmanage.Course Sub Title') }}"
                                                                               type="text" name="course_sub_title_1"
                                                                               {{ $errors->has('course_sub_title_1') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->course_sub_title_1 : ''}}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                            <div class="row">
                                                                                <div class="col-xl-6">
                                                                                    <label class="primary_input_label"
                                                                                        for="free_multi_course_input">Free Courses</label>
                                                                                        <select name="courses[]" id="free_multi_course_input" class="primary_multiselect mb-15" data-maximum-selection-length="20" multiple>
                                                                                        </select>
                                                                                </div>
                                                                                <div class="col-xl-6">
                                                                                    <label class="primary_input_label"
                                                                                        for="premimum_multi_course_input">Premium Courses</label>
                                                                                        <select name="courses[]" id="premimum_multi_course_input" class="primary_multiselect mb-15" data-maximum-selection-length="20" multiple>
                                                                                        </select>
                                                                                </div>
                                                                            </div>
                                                                                <div class="col-xl-12 text-right">
                                                                                    <button id="add_courses_btn" type="submit"
                                                                                            class="primary-btn small fix-gr-bg  mt-3  submit_btn" data-toggle="tooltip"
                                                                                            title="" data-original-title="">
                                                                                        <span class="ti-plus"></span> 
                                                                                        <i class="loading-spinner fa fa-lg fas fa-spinner fa-spin"></i>ADD COURSE</label>
                                                                                    </button>
                                                                                </div>
                                                                            <div class="row" id="courseList">
                                                                                @include('frontendmanage::sub_sec_featured_courses')
                                                                            </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                @elseif($block->id==18 || $block->block_name == 'Promo Section')
                                                    <div data-id="{{$block->id}}" class="row">
                                                        <div class="col-xl-12 ">
                                                            <div class="mb_25">
                                                                <label class="switch_toggle "
                                                                       for="show_promo_section">
                                                                    <input type="checkbox" class="status_enable_disable"
                                                                           name="show_promo_section"
                                                                           id="show_promo_section"
                                                                           @if (@$home_content->show_promo_section == 1) checked
                                                                           @endif value="1">
                                                                    <i class="slider round"></i>
                                                                </label>
                                                                Promo Section Show In Homepage
                                                                <i class="ti-move  float-right"></i>
                                                            </div>
                                                        </div>

                                                        <div id="show_promo_section_box" class="col-md-12"
                                                             style="@if (@$home_content->show_promo_section == 0) display:none
                                                             @endif ">
                                                             {{-- Promo (1) --}}
                                                            <div class="mt_25">
                                                                <label class="switch_toggle "
                                                                        for="show_promo1_section">
                                                                    <input type="checkbox" class="status_enable_disable"
                                                                                name="show_promo1_section"
                                                                                id="show_promo1_section"
                                                                                @if (@$home_content->show_promo1_section == 1) checked
                                                                                @endif value="1">
                                                                    <i class="slider round"></i>
                                                                </label>
                                                                <label class= "font-weight-bold">Promo (1)</label>
                                                            </div>
                                                            <div class="row col-xl-12 mb-25" id="show_promo1_section_box" style="@if (@$home_content->show_promo1_section == 0) display:none @endif ">
                                                                {{-- <div class="col-xl-12">
                                                                    <label class="primary_input_label font-weight-bold">Promo (1)</label>
                                                                </div> --}}
                                                                <div class="col-xl-3"> 
                                                                    <div class="primary_input mb-25">
                                                                        <img class="  imagePreview16"
                                                                                style="max-width: 100%; height: auto;"
                                                                                src="{{asset('/'.$home_content->promo_image_1)}}"
                                                                                alt="" width="245px" height="281px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-9"> 
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <div class="primary_file_uploader">
                                                                            <input class="primary-input  filePlaceholder {{ @$errors->has('promo_image_1') ? ' is-invalid' : '' }}" type="text" id="" placeholder="Browse file"
                                                                                readonly="" {{ $errors->has('promo_image_1') ? ' autofocus' : '' }}>
                                                                            <button class="" type="button">
                                                                                <label class="primary-btn small fix-gr-bg" for="file16">{{ __('common.Browse') }}</label>
                                                                                <input type="file" class="d-none imgInput16" name="promo_image_1"
                                                                                    id="file16">
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label"
                                                                               for="">Promo Title (1)</label>
                                                                        <input class="primary_input_field"
                                                                               placeholder="Promo Title (1)"
                                                                               type="text" name="promo_title_1"
                                                                               {{ $errors->has('promo_title_1') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->promo_title_1 : ''}}">
                                                                    </div>

                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label"
                                                                               for="">Promo Subtitle (1)</label>
                                                                        <input class="primary_input_field"
                                                                               placeholder="Promo Sub Title (1)"
                                                                               type="text"
                                                                               name="promo_sub_title_1"
                                                                               {{ $errors->has('promo_sub_title_1') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->promo_sub_title_1 : ''}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mt_25">
                                                                <label class="switch_toggle "
                                                                        for="show_promo2_section">
                                                                    <input type="checkbox" class="status_enable_disable"
                                                                                name="show_promo2_section"
                                                                                id="show_promo2_section"
                                                                                @if (@$home_content->show_promo2_section == 1) checked
                                                                                @endif value="1">
                                                                    <i class="slider round"></i>
                                                                </label>
                                                                <label class= "font-weight-bold">Promo (2)</label>
                                                            </div>
                                                            <div class="row col-xl-12 mb-25" id="show_promo2_section_box" style="@if (@$home_content->show_promo2_section == 0) display:none @endif ">
                                                                {{-- <div class="col-xl-12">
                                                                    <label class="primary_input_label font-weight-bold">Promo (2)</label>
                                                                </div> --}}
                                                                <div class="col-xl-3"> 
                                                                    <div class="primary_input mb-25">
                                                                        <img class="  imagePreview17"
                                                                                style="max-width: 100%; height: auto;"
                                                                                src="{{asset('/'.$home_content->promo_image_2)}}"
                                                                                alt="" width="245px" height="281px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-9"> 
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <div class="primary_file_uploader">
                                                                            <input class="primary-input  filePlaceholder {{ @$errors->has('promo_image_2') ? ' is-invalid' : '' }}" type="text" id="" placeholder="Browse file"
                                                                                readonly="" {{ $errors->has('promo_image_2') ? ' autofocus' : '' }}>
                                                                            <button class="" type="button">
                                                                                <label class="primary-btn small fix-gr-bg" for="file17">{{ __('common.Browse') }}</label>
                                                                                <input type="file" class="d-none imgInput17" name="promo_image_2"
                                                                                    id="file17">
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label"
                                                                               for="">Promo Title (1)</label>
                                                                        <input class="primary_input_field"
                                                                               placeholder="Promo Title (2)"
                                                                               type="text" name="promo_title_2"
                                                                               {{ $errors->has('promo_title_2') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->promo_title_2 : ''}}">
                                                                    </div>

                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label"
                                                                               for="">Promo Subtitle (2)</label>
                                                                        <input class="primary_input_field"
                                                                               placeholder="Promo Sub Title (2)"
                                                                               type="text"
                                                                               name="promo_sub_title_2"
                                                                               {{ $errors->has('promo_sub_title_2') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->promo_sub_title_2 : ''}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mt_25">
                                                                <label class="switch_toggle "
                                                                        for="show_promo3_section">
                                                                    <input type="checkbox" class="status_enable_disable"
                                                                                name="show_promo3_section"
                                                                                id="show_promo3_section"
                                                                                @if (@$home_content->show_promo3_section == 1) checked
                                                                                @endif value="1">
                                                                    <i class="slider round"></i>
                                                                </label>
                                                                <label class= "font-weight-bold">Promo (3)</label>
                                                            </div>
                                                            <div class="row col-xl-12 mb-25" id="show_promo3_section_box" style="@if (@$home_content->show_promo3_section == 0) display:none @endif ">
                                                                {{-- <div class="col-xl-12">
                                                                    <label class="primary_input_label font-weight-bold">Promo (3)</label>
                                                                </div> --}}
                                                                <div class="col-xl-3"> 
                                                                    <div class="primary_input mb-25">
                                                                        <img class="  imagePreview18"
                                                                                style="max-width: 100%; height: auto;"
                                                                                src="{{asset('/'.$home_content->promo_image_3)}}"
                                                                                alt="" width="245px" height="281px">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-9"> 
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <div class="primary_file_uploader">
                                                                            <input class="primary-input  filePlaceholder {{ @$errors->has('promo_image_3') ? ' is-invalid' : '' }}" type="text" id="" placeholder="Browse file"
                                                                                readonly="" {{ $errors->has('promo_image_3') ? ' autofocus' : '' }}>
                                                                            <button class="" type="button">
                                                                                <label class="primary-btn small fix-gr-bg" for="file18">{{ __('common.Browse') }}</label>
                                                                                <input type="file" class="d-none imgInput18" name="promo_image_3"
                                                                                    id="file18">
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label"
                                                                               for="">Promo Title (1)</label>
                                                                        <input class="primary_input_field"
                                                                               placeholder="Promo Title (3)"
                                                                               type="text" name="promo_title_3"
                                                                               {{ $errors->has('promo_title_3') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->promo_title_3 : ''}}">
                                                                    </div>
                                                                    ...
                                                                    <div class="primary_input mb-25">
                                                                        <label class="primary_input_label"
                                                                               for="">Promo Subtitle (2)</label>
                                                                        <input class="primary_input_field"
                                                                               placeholder="Promo Sub Title (3)"
                                                                               type="text"
                                                                               name="promo_sub_title_3"
                                                                               {{ $errors->has('promo_sub_title_3') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->promo_sub_title_3 : ''}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                @elseif($block->id==19 || $block->block_name == 'Corporate Access Promo Section')
                                                    <div data-id="{{$block->id}}" class="row">
                                                        <div class="col-xl-12 ">
                                                            <div class="mb_25">
                                                                <label class="switch_toggle "
                                                                       for="show_corporate_access_promo_section">
                                                                    <input type="checkbox" class="status_enable_disable"
                                                                           name="show_corporate_access_promo_section"
                                                                           id="show_corporate_access_promo_section"
                                                                           @if (@$home_content->show_corporate_access_promo_section == 1) checked
                                                                           @endif value="1">
                                                                    <i class="slider round"></i>
                                                                </label>Corporate Access Promotion Section Show In Homepage
                                                                <i class="ti-move  float-right"></i>
                                                            </div>
                                                        </div>

                                                        <div id="show_corporate_access_promo_section_box" class="col-xl-12"
                                                             style="@if (@$home_content->show_corporate_access_promo_section == 0) display:none
                                                             @endif ">
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <input class="primary_input_field"
                                                                               placeholder="{{ __('frontendmanage.Title') }}"
                                                                               type="text"
                                                                               name="corporate_access_promo_title"
                                                                               {{ $errors->has('corporate_access_promo_title') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->corporate_access_promo_title : ''}}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <input class="primary_input_field"
                                                                               placeholder="{{ __('frontendmanage.Sub Title') }}"
                                                                               type="text"
                                                                               name="corporate_access_promo_sub_title"
                                                                               {{ $errors->has('corporate_access_promo_sub_title') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->corporate_access_promo_sub_title : ''}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                @elseif($block->id==20 || $block->block_name == 'Homepage Advertisement')
                                                    <div data-id="{{$block->id}}" class="row">
                                                        <div class="col-xl-12 ">
                                                            <div class="mb_25">
                                                                <label class="switch_toggle "
                                                                       for="show_hp_advertisement_section">
                                                                    <input type="checkbox" class="status_enable_disable"
                                                                           name="show_hp_advertisement_section"
                                                                           id="show_hp_advertisement_section"
                                                                           @if (@$home_content->show_hp_advertisement_section == 1) checked
                                                                           @endif value="1">
                                                                    <i class="slider round"></i>
                                                                </label>Home Page Advertisement Section Show In Homepage
                                                                <i class="ti-move  float-right"></i>
                                                            </div>
                                                        </div>

                                                        <div id="show_hp_advertisement_section_box" class="col-md-12"
                                                             style="@if (@$home_content->show_hp_advertisement_section == 0) display:none
                                                             @endif ">
                                                            <div class="row">
                                                                <div class="col-xl-4">
                                                                    <div class="primary_input mb-25">
                                                                        <img class="  imagePreview19"
                                                                             style="max-width: 100%"
                                                                             src="{{asset('/'.$home_content->hp_advertisement_banner)}}"
                                                                             alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-8">
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <div class="primary_file_uploader">
                                                                            <input
                                                                                    class="primary-input  filePlaceholder {{ @$errors->has('hp_advertisement_banner') ? ' is-invalid' : '' }}"
                                                                                    type="text" id=""
                                                                                    placeholder="Browse file"
                                                                                    readonly="" {{ $errors->has('hp_advertisement_banner') ? ' autofocus' : '' }}>
                                                                            <button class="" type="button">
                                                                                <label
                                                                                        class="primary-btn small fix-gr-bg"
                                                                                        for="file19">{{ __('common.Browse') }}</label>
                                                                                <input type="file"
                                                                                       class="d-none imgInput19"
                                                                                       name="hp_advertisement_banner"
                                                                                       id="file19">
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-xl-12">
                                                                    <div class="primary_input mb-25">
                                                                        ...
                                                                        <input class="primary_input_field"
                                                                               placeholder="{{ __('frontendmanage.Title') }}"
                                                                               type="text" name="hp_advertisement_title"
                                                                               {{ $errors->has('hp_advertisement_title') ? ' autofocus' : '' }}
                                                                               value="{{isset($home_content)? $home_content->hp_advertisement_title : ''}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        let show_promo_section = $('#show_promo_section');
        let show_promo_section_box = $('#show_promo_section_box');
        show_promo_section.change(function () {
            if (show_promo_section.is(':checked')) {
                show_promo_section_box.show();
            } else {
                show_promo_section_box.hide();
            }
        });

        let show_corporate_access_promo_section = $('#show_corporate_access_promo_section');
        let show_corporate_access_promo_section_box = $('#show_corporate_access_promo_section_box');
        show_corporate_access_promo_section.change(function () {
            if (show_corporate_access_promo_section.is(':checked')) {
                show_corporate_access_promo_section_box.show();
            } else {
                show_corporate_access_promo_section_box.hide();
            }
        });

        let show_hp_advertisement_section = $('#show_hp_advertisement_section');
        let show_hp_advertisement_section_box = $('#show_hp_advertisement_section_box');
        show_hp_advertisement_section.change(function () {
            if (show_hp_advertisement_section.is(':checked')) {
                show_hp_advertisement_section_box.show();
            } else {
                show_hp_advertisement_section_box.hide();
            }
        });

        let show_featured_course_section = $('#show_featured_course_section');
        let show_featured_course_section_box = $('#show_featured_course_section_box');
        show_featured_course_section.change(function () {
            if (show_featured_course_section.is(':checked')) {
                show_featured_course_section_box.show();
            } else {
                show_featured_course_section_box.hide();
            }
        });

        let show_promo1_section = $('#show_promo1_section');
        let show_promo1_section_box = $('#show_promo1_section_box');
        show_promo1_section.change(function () {
            if (show_promo1_section.is(':checked')) {
                show_promo1_section_box.show();
            } else {
                show_promo1_section_box.hide();
            }
        });

        let show_promo2_section = $('#show_promo2_section');
        let show_promo2_section_box = $('#show_promo2_section_box');
        show_promo2_section.change(function () {
            if (show_promo2_section.is(':checked')) {
                show_promo2_section_box.show();
            } else {
                show_promo2_section_box.hide();
            }
        });

        let show_promo3_section = $('#show_promo3_section');
        let show_promo3_section_box = $('#show_promo3_section_box');
        show_promo3_section.change(function () {
            if (show_promo3_section.is(':checked')) {
                show_promo3_section_box.show();
            } else {
                show_promo3_section_box.hide();
            }
        });
        ...
        /* 05-12-2022 promo_section images and adv banner start*/
        ...
        function readURL17(input) {
            if (input.files && input.files[0]) {
                var reader = new FileReader();
                reader.onload = function (e) {
                    $(".imagePreview17").attr('src', e.target.result);
                }
                reader.readAsDataURL(input.files[0]); // convert to base64 string
            }
        }

        $(".imgInput17").change(function () {
            readURL17(this);
        });
        ...
        function readURL18(input) {
            if (input.files && input.files[0]) {
                var reader = new FileReader();
                reader.onload = function (e) {
                    $(".imagePreview18").attr('src', e.target.result);
                }
                reader.readAsDataURL(input.files[0]); // convert to base64 string
            }
        }

        $(".imgInput18").change(function () {
            readURL18(this);
        });
        ...
        function readURL19(input) {
            if (input.files && input.files[0]) {
                var reader = new FileReader();
                reader.onload = function (e) {
                    $(".imagePreview19").attr('src', e.target.result);
                }
                reader.readAsDataURL(input.files[0]); // convert to base64 string
            }
        }

        $(".imgInput19").change(function () {
            readURL19(this);
        });
        /* 05-12-2022 promo_section images and adv banner end*/
        ...
        $(document).ready(function() {
            // Select2 Multiple
            $('#free_multi_course_input').select2({
                width: "100%",
                placeholder: "Select Free Courses",
                allowClear: true,
                ajax: {
                    url: "{{  route('courses_which_not_added_with_ajax') }}",
                    dataType: 'json',
                    delay: 250,
            ...
            $('#premimum_multi_course_input').select2({
                width: "100%",
                placeholder: "Select Premium Courses",
                allowClear: true,
                ajax: {
                    url: "{{  route('courses_which_not_added_with_ajax') }}",
                    dataType: 'json',
