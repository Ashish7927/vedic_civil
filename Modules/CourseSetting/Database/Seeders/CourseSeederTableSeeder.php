...
//        1
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '1.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '1.' . 'jpg',
        ]);
//Course 2
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '2.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '2.' . 'jpg',
        ]);
//Course 3
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '3.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '3.' . 'jpg',
        ]);
...
//        Course 4
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '4.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '4.' . 'jpg',
        ]);
//Course 5
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '5.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '5.' . 'jpg',
        ]);
//        Course 6
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '6.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '6.' . 'jpg',
        ]);
        ...
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '7.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '7.' . 'jpg',
        ]);
        ...
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '8.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '8.' . 'jpg',
        ]);
        ...
        Course::insert([
            ...
            'total_enrolled' => 1,
            'reveune' => '50',
            'image' => 'frontend/elatihlmstheme/img/course/' . '9.' . 'jpg',
            'thumbnail' => 'frontend/elatihlmstheme/img/course/' . '9.' . 'jpg',
        ]);
        ...
        $course->image = 'frontend/elatihlmstheme/img/course/' . '1.' . 'jpg';
        $course->thumbnail = 'frontend/elatihlmstheme/img/course/' . '1.' . 'jpg';
        $course->type = 3;
        $course->save();
        ...
        $course->image ='frontend/elatihlmstheme/img/course/' . '2.' . 'jpg';
        $course->thumbnail ='frontend/elatihlmstheme/img/course/' . '2.' . 'jpg';
        $course->type = 3;
        $course->save();
        ...
        $course->image = 'frontend/elatihlmstheme/img/course/' . '3.' . 'jpg';
        $course->thumbnail = 'frontend/elatihlmstheme/img/course/' . '3.' . 'jpg';
        $course->type = 3;
        $course->save();
        ...
        $course->image = 'frontend/elatihlmstheme/img/course/' . '4.' . 'jpg';
        $course->thumbnail ='frontend/elatihlmstheme/img/course/' . '4.' . 'jpg';
        $course->type = 3;
        $course->save();
        ...
        $course->image ='frontend/elatihlmstheme/img/course/' . '5.' . 'jpg';
        $course->thumbnail = 'frontend/elatihlmstheme/img/course/' . '5.' . 'jpg';
        $course->type = 3;
        $course->save();
        ...
        $course->image = 'frontend/elatihlmstheme/img/course/' . '6.' . 'jpg';
        $course->thumbnail = 'frontend/elatihlmstheme/img/course/' . '6.' . 'jpg';
        $course->type = 3;
        $course->save();
        ...
        $course->image = 'frontend/elatihlmstheme/img/course/' . '7.' . 'jpg';
        $course->thumbnail ='frontend/elatihlmstheme/img/course/' . '7.' . 'jpg';
        $course->type = 3;
        $course->save();
        ...
        $course->image ='frontend/elatihlmstheme/img/course/' . '8.' . 'jpg';
        $course->thumbnail = 'frontend/elatihlmstheme/img/course/' . '8.' . 'jpg';
        $course->type = 3;
        $course->save();
        ...
        $course->image ='frontend/elatihlmstheme/img/course/' . '1.' . 'jpg';
        $course->thumbnail = 'demo/course/image/' . '1.' . 'png';
        $course->type = 3;
        $course->save();
