...
class UpdateEmailTemplateCourseUpdated extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $template = \Modules\SystemSetting\Entities\EmailTemplate::where('act', 'course_updated')->first();
        if (!$template) {
            $template = new \Modules\SystemSetting\Entities\EmailTemplate();
            $template->act = 'course_updated';
        }
        $shortCode = '{"cp_name":"Content Provider Name", "course":"Course Name", "course_duration":"Duration of Content", "course_submission_date":"Submitted Date"}';
        ...
        $html = '
            ...
            <div class="">
                ...
                <div style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; padding: 20px;">
                    ...
                    <p style="color: rgb(85, 85, 85);">A new Course has successfully created</p>
                </div>
                    ...
                    <p style="color: rgb(85, 85, 85);"> Duration of Content : <b>' . $body['course_duration'] . '</b></p>
                </div>
