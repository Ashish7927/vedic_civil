    ...
    public function up()
    {
        Schema::table('about_pages', function ($table) {
            ...
            if (!Schema::hasColumn('about_pages', 'live_class_image')) {
                $table->string('live_class_image')->default('frontend/edume/img/lms_udemy/become_ins2.png');
            }

            if (!Schema::hasColumn('about_pages', 'counter_bg')) {
                $table->string('counter_bg')->default('frontend/edume/img/about/counter_bg.png');
            }
