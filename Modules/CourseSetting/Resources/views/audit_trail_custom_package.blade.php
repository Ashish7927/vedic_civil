    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>{{__('common.Audit Trail')}} {{__('common.Custom Package')}}</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">{{__('dashboard.Dashboard')}}</a>
                    <a href="#">{{__('common.Audit Trail')}} {{__('common.Custom Package')}}</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{__('common.Audit Trail')}} {{__('common.Custom Package')}}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
...
@push('scripts')
    ...
    @php
        $url = route('admin.auditTrailCustomPackageData');
    @endphp
    ...
    <script>
        ...
        $(document).on('click', '.viewStudentAuditTrail', function () {
            var id = $(this).data('id');
            var url = "{{ route('admin.getCompareAuditTrailCustomPackageData', ':id') }}";
