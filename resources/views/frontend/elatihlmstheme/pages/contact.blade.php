...
@section('title'){{Settings('site_title')  ? Settings('site_title')  : 'e-Latih LMS'}} | {{__('frontend.Contact Us')}} @endsection
...
@section('js')
    ...
    <script src="{{ asset('public/frontend/elatihlmstheme') }}/js/map.js"></script>
    <script src="{{asset('public/frontend/elatihlmstheme/js/contact.js')}}"></script>
@endsection
