                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="section__title3 mb_40">
                                    <h3 class="mb-0">My {{__('courses.Purchase')}}</h3>
                                    <h4></h4>
                                </div>
                            </div>
                        </div>
                                            ...
                                            @if(isset($enrolls))
                                                @foreach ($enrolls as $key=>$enroll)
                                                    <tr>
                                                        ...
                                                        @if (count($enroll->courses) > 0)
                                                            <td>
                                                                <a href="{{ route('orderReceipt', ['id' => $enroll->id, 'type' => 'receipt']) }}" class="link_value theme_btn small_btn4">{{__('payment.Receipt')}}</a>
                                                                <a href="{{ route('orderReceipt', ['id' => $enroll->id, 'type' => 'invoice']) }}" class="link_value theme_btn small_btn4">{{__('payment.Invoice')}}</a>
                                                            </td>
                                                        @endif
                                                    </tr>
                                                @endforeach
