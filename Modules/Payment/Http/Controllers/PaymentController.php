...
class PaymentController extends Controller
{
    ...
    public function setCommission()
    {
        try {
            ...
            $cut_off_date = Settings('cut_off_date');
            ...
            return view('payment::commission', compact('users', 'allcourses', 'courses', 'commission', 'hrdc_commission', 'instructor_commission', 'instructors', 'cut_off_date'));
        } catch (\Exception $e) {
    ...
    public function courseCommission(Request $request)
    {
        ...
        $rules = [
            ...
            'hrdc_commission' => 'required|numeric|min:0|max:100',
            'course' => 'required',
        ];
        ...
        try {
            ...
            $course->hrdc_commission = $request->hrdc_commission;
            $course->save();
    ...
    public function saveFlat(Request $request)
    {
        ...
        try {
            ...
            UpdateGeneralSetting('hrdc_commission',$request->hrdc_commission);
            UpdateGeneralSetting('cut_off_date',$request->cut_off_date);
    ...
    public function instructor_commission(Request $request)
    {
        ...
        try {
            ...
            $user->hrdc_commission = $request->hrdc_commission;
            $user->save();
            Toastr::success(trans('common.Operation successful'), trans('common.Success'));
