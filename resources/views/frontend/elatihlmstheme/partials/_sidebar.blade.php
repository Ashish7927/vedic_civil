                ...
                <li>
                    <a href="{{route('studentDashboard')}}"
                       class="  d-flex align-items-center {{ routeIs('studentDashboard')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/dashboard.svg" alt="">
                        </div>
                ...
                <li>
                    <a href="{{route('myCourses')}}"
                       class=" d-flex align-items-center {{ routeIs('myCourses')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/my_course.svg" alt="">
                        </div>
                ...
                <li>
                    <a href="{{route('myClasses')}}"
                       class=" d-flex align-items-center {{ routeIs('myClasses')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/my_quiz.svg" alt="">
                        </div>
           ...
           <!-- <li>
                <a href="{{route('myNotificationSetup')}}"
                   class=" d-flex align-items-center  {{ routeIs('myNotificationSetup')  ? 'active' : '' }}">
                    <div class="menu_icon">
                        <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/purchase_history.svg" alt="">
                    </div>
            ...
            @if (permissionCheck('myCertificate'))
              <li>
                    <a href="{{route('myHistory')}}"
                       class=" d-flex align-items-center  {{ routeIs('myHistory')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/purchase_history.svg" alt="">
                        </div>
                        <span>{{__('certificate.My History')}}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{route('myCertificate')}}"
                       class=" d-flex align-items-center  {{ routeIs('myCertificate')  ? 'active' : '' }}">
                        ...
                        <span>{{__('certificate.My Certificates & Transcript')}}</span>
                    </a>
                </li>
            @endif
                ...
                <li>
                    <a href="{{route('myPurchases')}}"
                       class=" d-flex align-items-center  {{ routeIs('myPurchases')  ? 'active' : '' }}">
                        ...
                        <span>My {{__('courses.Purchase')}}</span>
                    </a>
                </li>
            @endif
                ...
                <li>
                    <a href="{{route('myProfile')}}"
                       class=" d-flex align-items-center {{ routeIs('myProfile')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/edit_pro.svg" alt="">
                        </div>
                ...
                <li>
                    <a href="{{route('myAccount')}}"
                       class=" d-flex align-items-center {{ routeIs('myAccount')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/account_setting.svg" alt="">
                        </div>
