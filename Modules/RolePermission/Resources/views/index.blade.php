                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if(isset($role))
                                @if (permissionCheck('permission.role.roles.update'))
                                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => route('permission.role.roles.update',$role->id),'method' => 'PUT']) }}
                                @endif
                            @else
                                @if (permissionCheck('permission.role.roles.store'))
                                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'permission.role.roles.store', 'method' => 'POST']) }}
                                @endif
                                ...
                                <div class="add-visitor">
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12 text-center">
                                            @if(permissionCheck('permission.role.roles.update') || permissionCheck('permission.role.roles.store'))
                                                            ...
                                                            @if(@$role->type == 'User Defined')
                                                                <div class="dropdown CRM_dropdown d-inline">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                                                        ...
                                                                        @if(permissionCheck('permission.role.roles.destroy'))
                                                                            <a onclick="confirm_modal('{{route('permission.role.roles.destroy', $role->id)}}');" class="dropdown-item edit_brand">{{__('common.delete')}}</a>
                                                                        @endif
