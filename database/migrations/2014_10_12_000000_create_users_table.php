...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('name');
            $table->string('photo')->nullable()->default('demo/user/' . 'admin.jpg');
            $table->string('image')->nullable()->default('demo/user/' . 'admin.jpg');
            $table->string('avatar')->nullable()->default('demo/user/' . 'admin.jpg');
            ...
            $table->string('payout_icon')->default('uploads/payout/pay_1.png');
