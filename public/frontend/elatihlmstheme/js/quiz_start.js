...
$(".next").click(function (e) {
    ...
    if(question_type == 'F' || question_type == 'Mt'){
        ans = $(".tab-pane:visible").find('.quizAns').val();
    }
    else{
        ans = $(".tab-pane:visible").find('.quizAns:checked').val();
    }
    console.log(ans);

    if (ans == "undefined" || ans == "" || ans == null) {
        console.log(question_type)
        if (question_type == 'M' || question_type == 'F') {
...
function questionSubmitSingle(question_type, assign_id) {
    ...
    else if (question_type == "Mt" || question_type == "F") {
        data = $('.quizAns').val();
    } else {
