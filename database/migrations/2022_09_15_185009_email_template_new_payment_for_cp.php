...
class EmailTemplateNewPaymentForCp extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $template = \Modules\SystemSetting\Entities\EmailTemplate::where('act', 'new_payment_for_cp')->first();
        if (!$template) {
            $template = new \Modules\SystemSetting\Entities\EmailTemplate();
            $template->act = 'new_payment_for_cp';
        }
        $shortCode = '{"trainer_name": "Trainer Name","amount": "Amount","issue_date": "Issue Date"}';
        $subject = 'New Payout for CP Created';
        $br = "<br/>";
        ...
        $html = '
            ...
            <div class="">
                ...
                <div style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; padding: 20px;">
                    ...
                    <p style="color: rgb(85, 85, 85);">A new CP Payout has successfully created</p>
                </div>

                <p style="color: rgb(85, 85, 85);"> Trainer Name : <b>' . $body['trainer_name'] . '</b></p>
