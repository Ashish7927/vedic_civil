...
<link rel="stylesheet" href="{{ asset('Modules/CourseSetting/Resources/assets/css/style.css') }}?{{ $version }}">
<style type="text/css">
        ...
        <div class="single_permission" id="chapter_id{{$key}}">
            <div class="permission_header d-flex align-items-center justify-content-between">
                ...
                @if (isset($data['chapter_id']))
                        @if($data['chapter_id']==$chapter->id)
                            <div class="arrow"  data-toggle="collapse" data-target="#Rolechapter_id{{$key}}"  aria-expanded="true">
                        @else
                            <div class="arrow collapsed"  data-toggle="collapse" data-target="#Rolechapter_id{{$key}}">
                       @endif
                @else
                    <div class="arrow collapsed"  data-toggle="collapse" data-target="#Rolechapter_id{{$key}}">
                @endif
            ...
            <div id="Rolechapter_id{{$key}}" class="collapse capter_body @if(isset($data['chapter_id']) && $data['chapter_id']==$chapter->id) show @endif">
                ...
                <div class="row d-flex mt-30 pl-20">
                    <div class="col-lg-2">
                        <button class="primary-btn icon-only mr-10 fix-gr-bg add_option_box" data-chapter="{{$key}}" id="add_option_box{{$key}}" ><i class="ti-plus"></i></button>
                        <button class="primary-btn icon-only mr-10 fix-gr-bg minus_option_box" data-chapter="{{$key}}" id="minus_option_box{{$key}}" style="display: none">X</button>
                    </div>
                    <div class="col-lg-10">
                        <div class="lms_option_box d-flex" >
                            <div class="pt-20 pb-30 lms_option_list_inside" id="lms_option_list{{$key}}" style="display: none">
                                <div class="add-item-forms--inline-menu--1OTdc">
                                    ...
                                    <button data-purpose="add-quiz-btn" aria-label="Add Quiz" type="button" data-chapter="{{$key}}" id="show_quiz_section_inside" class="ellipsis btn btn-tertiary btn-block show_quiz_section_inside">
                        ...
                        <div
                            ...
                            @if ($lesson->is_quiz==1)
                                @foreach ($lesson->quiz as $quiz_key=> $quiz)
                                    ...
                                    <a class="primary-btn icon-only mr-10 fix-gr-bg quiz_inside_icon collapsed" data-toggle="collapse" href="#collapseExample{{$lesson->id}}{{$quiz->id}}" role="button" aria-expanded="false" aria-controls="collapseExample">
                                        <i class="ti-arrow-down"></i>
                                            ...
                                            <div class="dropdown CRM_dropdown">
                                                ...
                                                <div
                                                    ...
                                                    @if ($lesson->is_quiz==1)
                                                        <a class="dropdown-item add_question" data-lesson_id="{{$quiz->id}}" data-chapter_id="{{$chapter->id}}"  href="#">Add Question</a>
                                                    @endif
                                            ...
                                            <div class="collapse w-100 mt-10" id="collapseExample{{$lesson->id}}{{$quiz->id}}">
                                                    ...
                                                    @if ($quiz->assign->count()>0)
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{url('admin/course/course-question-show/'.$assign->questionBank->id.'/'.$course->id.'/'.$chapter->id.'/'.$lesson->id)}}"><i class="ti-pencil-alt"></i> </a>
                                                                    <a href="{{url('quiz/online-exam-question-delete/'.$course->id.'/'.$quiz->id.'/'.$assign->questionBank->id)}}" class="ml-10" title="Delete"><i class="ti-trash"></i> </a>
