                        ...
                        <form id="filter-form" method="post" action="{{ route('learner_list_excel_download') }}">
                            ...
                            <div class="row">
                                {{-- <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="primary_input_label">Created At</label>
                                        <input class="primary_input_field" type="date" name="created_at" id="created_at">
                                    </div>
                                </div> --}}
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="primary_input form-group">
                                        <label class="primary_input_label">Citizenship</label>
                                        <select class="primary_select form-control select2" name="citizenship" id="citizenship">
                                ...
                                <div class="col-md-3">
                                    <div class="primary_input form-group">
                                        <label class="primary_input_label">Race</label>
                                        <select class="primary_select" name="race" id="race">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="primary_input_label">NRIC Number</label>
                                        <input class="primary_input_field" type="text" name="identification_number" id="identification_number">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="primary_input_label">Employment Status</label>
                                        <select class="primary_select" name="employment_status" id="filter_employment_status">
                                ...
                                <div class="col-md-3" id="job_designation_col_div">
                                    <div class="form-group">
                                        <label class="primary_input_label">Job Designation</label>
                                        <select class="primary_select" name="job_designation" id="job_designation_div">
                                            ...
                                            <option value="Service and Sale Worker">Service and Sale Worker</option>
                                ...
                                <div class="col-md-3" id="sector_col_div">
                                    <div class="form-group">
                                        <label class="primary_input_label">Sector</label>
                                        <select class="primary_select" name="sector" id="sector_div">
                                ...
                                <div class="col-md-3" id="not_working_col_div">
                                    <div class="form-group">
                                        <label class="primary_input_label">Not Working Status</label>
                                        <select class="primary_select" name="not_working" id="not_working_div">
                                ...
                                <div class="col-md-3" id="business_nature_col_div">
                                    <div class="form-group">
                                        <label class="primary_input_label">Business Nature/Activity</label>
                                        <select class="primary_select business_nature" name="business_nature" id="business_nature_div">
                                            <option value="">Select Nature/Activity</option>
                                ...
                                <div class="col-md-3" id="business_nature_other_col_div">
                                    <div class="form-group">
                                        <label class="primary_input_label">Business Nature Others</label>
                                        <input type="text" class="primary_input_field" name="business_nature_other" id="business_nature_other_div">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="primary_input_label">Current Residing State</label>
                                        <select class="primary_select" name="current_residing" id="current_residing_div">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="primary_input_label">POSTCODE</label>
                                        <input type="text" class="primary_input_field" name="zip" id="zip">
                                    </div>
                                </div>
                            </div>
                            {{-- <hr> --}}
                            <div class="col-md-12 col-xl-12 mt-30">
                                <div class="search_course_btn">
                                    <button type="button" id="apply-filters" class="primary-btn radius_30px mr-10 fix-gr-bg">{{__('common.Filter History')}}</button>
                            ...
                            {{-- <div class="content-between" style="padding-bottom: 20px;">
                                <button type="button"  id="apply-filters"  class="btn btn-dark saveSilderBtn" style="    background: linear-gradient(90deg,#7c32ff,#c738d8); color:white; border: 0; border-radius: 30px;">Apply</button>
                                <button type="button" id="reset-filters"   class="btn btn-default" style="background:white;color:#1b191f;boder:1 px solid black;" data-dismiss="modal">Reset</button>
                            </div> --}}
                        </form>
                        <hr>
                    ...
                    <div class="modal-dialog modal_1000px modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('student.store')}}" method="POST" enctype="multipart/form-data" id="student_store">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-12">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field input-phone" value="{{ old('phone') }}"
                                                       ...
                                                       type="text" {{$errors->first('phone') ? 'autofocus' : ''}} onkeypress="javascript:return isNumber(event)">
                                            </div>
                                        </div>
                                    </div>
...
<?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="">Citizenship</label>
                                                <div class="input-group mb-2 mr-sm-2">
                                                <select class="primary_select citizenship"
                                                    name="citizenship" required>
                                                    <option value="Malaysian" {{old('citizenship') == 'Malaysian' ? "selected" : ""}}>Malaysian</option>
                                                        <option value="Non-Malaysian"  {{old('citizenship') == 'Non-Malaysian' ? "selected" : ""}}>Non-Malaysian</option>
                                            </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 nationalitydiv" <?php if(old('citizenship') == 'Non-Malaysian'){ ?> style="display:block" <?php }else{ ?>
                                            ...
                                            <div class="primary_input mb-25">
                                                ...
                                                <select class="primary_select"
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option value="{{@$country->id}}"
                                                                @if ($country->id=='132') selected @endif {{old('citizenship') == $country->id ? "selected" : ""}}>{{@$country->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-xl-6 racediv">
                                            <div class="primary_input mb-35">
                                                <label class="primary_input_label" for="">{{__('common.Race')}}
                                                </label>
                                                <select class="primary_select race"
                                                        data-course_id="{{@$course->id}}" name="race"
                                                        id="studentRace">
                                                    ...
                                                    <br/>
                                                    <div id="race_other"  <?php if(old('race') == 'Others'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                                    ...
                                                    <strong
                                                        class="text-danger">*</strong></label>
                                                <div class="input-group mb-2 mr-sm-2">
                                                    <input type="text" class="form-control primary_input_field" value="{{old('race_other')}}"
                                                    id="addPassword" name="race_other"
                                                    placeholder="Race Others" {{$errors->first('race_other') ? 'autofocus' : ''}}>
                                                </div>
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 racediv">
                                                ...
                                                <input type="text" class="form-control primary_input_field" value="{{old('identification_number')}}" name="identification_number" onkeypress="javascript:return isNumber(event)" id="identification_number"
                                                    placeholder="NRIC Number" {{$errors->first('identification_number') ? 'autofocus' : ''}}>
                                        </div>
                                    </div>
                                            <div class="col-xl-6">
                                            <div class="primary_input mb-35">
                                                ...
                                                <select class="primary_select"
                                                        data-course_id="{{@$course->id}}" name="employment_status"
                                                        id="employment_status">
                                                <option value="working" {{old('employment_status') == 'working' ? "selected" : ""}}>Working</option>
                                                <option value="not-working" {{old('employment_status') == 'not-working' ? "selected" : ""}}>Not Working</option>
                                                <option value="self-employed" {{old('employment_status') == 'self-employed' ? "selected" : ""}}>Self Employed</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-xl-6"  id="job_designation">
                                            <div class="primary_input mb-35">
                                                <label class="primary_input_label" for="">Job Designation
                                                </label>
                                                <select class="primary_select"
                                                        data-course_id="{{@$course->id}}" name="job_designation" >
                                                <option value="Manager" {{old('job_designation') == 'Manager' ? "selected" : ""}}>Manager</option>
                                                <option value="Professional" {{old('job_designation') == 'Professional' ? "selected" : ""}}>Professional</option>
                                                <option value="Technician and Associate Professional" {{old('job_designation') == 'Technician and Associate Professional' ? "selected" : ""}}>Technician and Associate Professional</option>
                                                <option value="Clerical Support Worker" {{old('job_designation') == 'Clerical Support Worker' ? "selected" : ""}}>Clerical Support Worker</option>
                                                <option value="Service and Sale Worker" {{old('job_designation') == 'Service and Sale Worker' ? "selected" : ""}}>Service and Sale Worker</option>
                                                <option value="Skilled Agricultural,Forestry and Fishery Worker" {{old('job_designation') == 'Skilled Agricultural,Forestry and Fishery Worker' ? "selected" : ""}}>Skilled Agricultural,Forestry and Fishery Worker</option>
                                                <option value="Craft and Related Trade Worker" {{old('job_designation') == 'Craft and Related Trade Worker' ? "selected" : ""}}>Craft and Related Trade Worker</option>
                                                <option value="Elementary Worker" {{old('job_designation') == 'Elementary Worker' ? "selected" : ""}}>Elementary Worker</option>
                                                <option value="Plant and Machine Operator and Assembler Worker" {{old('job_designation') == 'Plant and Machine Operator and Assembler Worker' ? "selected" : ""}}>Plant and Machine Operator and Assembler Worker</option>
                                                <option value="Armed Forced Worker" {{old('job_designation') == 'Armed Forced Worker' ? "selected" : ""}}>Armed Forced Worker</option>
                                                    </select>
                                                </div>
                                            </div>

                                             <div class="col-xl-6" id="business_nature" <?php if(old('employment_status') == 'self-employed'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                            <div class="primary_input mb-35">
                                                <label class="primary_input_label" for="">Business Nature/Activity
                                                </label>
                                                <select class="primary_select business_nature"
                                                        data-course_id="{{@$course->id}}" name="business_nature" >
                                                <option value="Accomodation/Food Beverage service Activities" {{old('business_nature') == 'Accomodation/Food Beverage service Activities' ? "selected" : ""}}>Accomodation/Food Beverage service Activities</option>
                                                <option value="Agriculture/Forestry/Fishing" {{old('business_nature') == 'Agriculture/Forestry/Fishing' ? "selected" : ""}}>Agriculture/Forestry/Fishing</option>
                                                <option value="Arts/Entertainment/Recreation/Construction" {{old('business_nature') == 'Arts/Entertainment/Recreation/Construction' ? "selected" : ""}}>Arts/Entertainment/Recreation/Construction</option>
                                                <option value="Education" {{old('business_nature') == 'Education' ? "selected" : ""}}>Education</option>
                                                <option value="Electricity/Gas/Steam/Air conditioning Supply" {{old('business_nature') == 'Electricity/Gas/Steam/Air conditioning Supply' ? "selected" : ""}}>Electricity/Gas/Steam/Air conditioning Supply</option>
                                                <option value="Financial/Insurance/Takaful activities" {{old('business_nature') == 'Financial/Insurance/Takaful activities' ? "selected" : ""}}>Financial/Insurance/Takaful activities</option>
                                                <option value="Human Health/Social Work Activities" {{old('business_nature') == 'Human Health/Social Work Activities' ? "selected" : ""}}>Human Health/Social Work Activities</option>
                                                <option value="Information/Communication" {{old('business_nature') == 'Information/Communication' ? "selected" : ""}}>Information/Communication</option>
                                                <option value="Manufacturing" {{old('business_nature') == 'Manufacturing' ? "selected" : ""}}>Manufacturing</option>
                                                <option value="Mining/Quarrying" {{old('business_nature') == 'Mining/Quarrying' ? "selected" : ""}}>Mining/Quarrying</option>
                                                <option value="Professional/Scientific/Technical Activities" {{old('business_nature') == 'Professional/Scientific/Technical Activities' ? "selected" : ""}}>Professional/Scientific/Technical Activities</option>
                                                <option value="Public Administration/Defence/Compulsory Social Security" {{old('business_nature') == 'Public Administration/Defence/Compulsory Social Security' ? "selected" : ""}}>Public Administration/Defence/Compulsory Social Security</option>
                                                <option value="Real Estate Activities" {{old('business_nature') == 'Real Estate Activities' ? "selected" : ""}}>Real Estate Activities</option>
                                                <option value="Transportation/Storage" {{old('business_nature') == 'Transportation/Storage' ? "selected" : ""}}>Transportation/Storage</option>
                                                <option value="Water Supply/Sewage/Waste Management/Remediation Activities" {{old('business_nature') == 'Water Supply/Sewage/Waste Management/Remediation Activities' ? "selected" : ""}}>Water Supply/Sewage/Waste Management/Remediation Activities</option>
                                                <option value="Wholesale/Retail Trade/Repair of Motor Vehicles/Motorcycles" {{old('business_nature') == 'Wholesale/Retail Trade/Repair of Motor Vehicles/Motorcycles' ? "selected" : ""}}>Wholesale/Retail Trade/Repair of Motor Vehicles/Motorcycles</option>
                                                <option value="Others" {{old('business_nature') == 'Others' ? "selected" : ""}}>Others</option>
                                                    </select>
                                                    <br/>
                                                    <div class="col-12 mt_20" id="business_nature_other" <?php if(old('business_nature') == 'Others'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                                        <br/>
                                <div class="input-group custom_group_field">
                                    <input type="text" class="form-control primary_input_field"
                                           ...
                                           aria-label="business_nature_other" name="business_nature_other" value="{{old('business_nature_other')}}">
                                </div>
                                <span class="text-danger" role="alert">{{$errors->first('business_nature_other')}}</span>
                                             ...
                                             <div class="col-xl-6" <?php if(old('employment_status') == 'not-working'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?> id="not_working">
                                            <div class="primary_input mb-35">
                                                ...
                                                <select class="primary_select"
                                                        data-course_id="{{@$course->id}}" name="not_working" >
                                                <option value="Student" {{old('not_working') == 'Student' ? "selected" : ""}}>Student</option>
                                                <option value="Fresh Graduate" {{old('not_working') == 'Fresh Graduate' ? "selected" : ""}}>Fresh Graduate</option>
                                                <option value="Retrenched" {{old('not_working') == 'Retrenched' ? "selected" : ""}}>Retrenched</option>
                                                <option value="Retired" {{old('not_working') == 'Retired' ? "selected" : ""}}>Retired</option>
                                                <option value="Home Worker/House Wife" {{old('not_working') == 'Home Worker/House Wife' ? "selected" : ""}}>Home Worker/House Wife</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <select class="primary_select sector"
                                                    name="sector">
                                                <option value="Manufacturing" {{old('sector') == 'Manufacturing' ? "selected" : ""}}>Manufacturing</option>
                                                <option value="Mining and quarrying" {{old('sector') == 'Mining and quarrying' ? "selected" : ""}}>Mining and quarrying</option>
                                                ...
                                                <option value="NGO" {{old('sector') == 'NGO' ? "selected" : ""}}>NGO</option>
                                                <option value="Services(eg: Financial Institution, Hospitality, F&B)" {{old('sector') == 'Services(eg: Financial Institution, Hospitality, F&B)' ? "selected" : ""}}>Services(eg: Financial Institution, Hospitality, F&B)</option>
                                                <option value="Others" {{old('sector') == 'Others' ? "selected" : ""}}>Others</option>
                                            </select>
                                            <br/>
                                                    <div id="sector_other" <?php if(old('sector') == 'Others'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                                    ...
                                                    <strong
                                                        class="text-danger">*</strong></label>
                                                <div class="input-group mb-2 mr-sm-2">
                                                    <input type="text" class="form-control primary_input_field" name="sector_other"
                                                    placeholder="Sector Others" {{$errors->first('sector_other') ? 'autofocus' : ''}}>
                                                </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <option value="Primary School" {{old('highest_academic') == 'Primary School' ? "selected" : ""}}>Primary School</option>
                                                <option value="Secondary School" {{old('highest_academic') == 'Secondary School' ? "selected" : ""}}>Secondary School</option>
                                                <option value="SPM/O-Level/SVM/equivalent" {{old('highest_academic') == 'SPM/O-Level/SVM/equivalent' ? "selected" : ""}}>SPM/O-Level/SVM/equivalent</option>
                                                <option value="Bachelor's Degree/equivalent" {{old('highest_academic') == 'Bachelor\'s Degree/equivalent' ? "selected" : ""}}>Bachelor's Degree/equivalent</option>
                                                <option value="Master's Degree/equivalent" {{old('highest_academic') == 'Master\'s Degree/equivalent' ? "selected" : ""}}>Master's Degree/equivalent</option>
                                                <option value="Doctoral Degree" {{old('highest_academic') == 'Doctoral Degree' ? "selected" : ""}}>Doctoral Degree</option>
                                            </select>
                                            </div>
                                        </div>
                                            <div class="col-xl-6">
                                                ...
                                                <select class="primary_select"
                                                        data-course_id="{{@$course->id}}" name="current_residing" >
                                    ...
                                    <div class="col-xl-6">
                                                ...
                                                <input type="text" class="form-control primary_input_field" value="{{old('zip')}}" name="zip" onkeypress="javascript:return isNumber(event)"
                                                    placeholder="Postcode" {{$errors->first('zip') ? 'autofocus' : ''}}>
                                        </div>
                                    </div>
                                        </div>
                                        <!-- <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field input-phoneedit" id="studentPhone"
                                                       ...
                                                       placeholder="-" type="text" onkeypress="javascript:return isNumber(event)">
                                            </div>
                                        </div>
...
<?php } ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 nationalityeditdiv" <?php if(old('citizenship') == 'Non-Malaysian'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                ...
                                                <select class="primary_select" id="studentnationality"
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option value="{{@$country->id}}"
                                                                @if ($country->id=='132') selected @endif>{{@$country->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                                </div>
                                        ...
                                        <div class="col-xl-6 raceeditdiv" <?php if(old('citizenship') == 'Malaysian'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                            <div class="primary_input mb-35">
                                                <label class="primary_input_label" for="">{{__('common.Race')}}
                                                </label>
                                                <select class="primary_select"  name="race"
                                                        id="studentRaceedit">
                                                ...
                                                <option value="Malay" {{old('race') == 'Malay' ? "selected" : ""}}>Malay</option>
                                                    ...
                                                    <br/>
                                                    <div id="race_otheredit"  <?php if(old('race') == 'Others'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                                     <label class="primary_input_label" for="">Race Others
                                                    <strong
                                                ...
                                                <div class="input-group mb-2 mr-sm-2">
                                                    <input type="text" class="form-control primary_input_field" value="{{old('race_other')}}"
                                                    id="race_other_input" name="race_other"
                                                    placeholder="Race Others" {{$errors->first('race_other') ? 'autofocus' : ''}}>
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-6 raceeditdiv">
                                                ...
                                                <input type="text" class="form-control primary_input_field" id="nricnumber" value="{{old('identification_number')}}" onkeypress="javascript:return isNumber(event)" name="identification_number"
                                                    placeholder="NRIC Number" {{$errors->first('identification_number') ? 'autofocus' : ''}}>
                                        </div>
                                    </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="primary_input mb-35">
                                                ...
                                                <select class="primary_select"
                                                        data-course_id="{{@$course->id}}" name="job_designation"  id="job_designationinput">
                                               <option value="Manager" {{old('job_designation') == 'Manager' ? "selected" : ""}}>Manager</option>
                                                <option value="Professional" {{old('job_designation') == 'Professional' ? "selected" : ""}}>Professional</option>
                                                <option value="Technician and Associate Professional" {{old('job_designation') == 'Technician and Associate Professional' ? "selected" : ""}}>Technician and Associate Professional</option>
                                                <option value="Clerical Support Worker" {{old('job_designation') == 'Clerical Support Worker' ? "selected" : ""}}>Clerical Support Worker</option>
                                             ...
                                             <div class="col-xl-6" <?php if(old('employment_status') == 'self-employed'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                            ...
                                            <div class="primary_input mb-35">
                                                ...
                                                <option value="Others" {{old('business_nature') == 'Others' ? "selected" : ""}}>Others</option>
                                                    ...
                                                    <br/>
                                                    <div class="col-12 mt_20" id="business_nature_otheredit" <?php if(old('business_nature') == 'Others'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                                        <br/>
                                <div class="input-group custom_group_field">
                                    <input type="text" class="form-control primary_input_field"
                                           placeholder="Business Nature Other"
                                           aria-label="business_nature_other" name="business_nature_other" value="{{old('business_nature_other')}}" id="business_nature_otherinput">
                                </div>
                                <span class="text-danger" role="alert">{{$errors->first('business_nature_other')}}</span>
                            </div>
                                                </div>
                                            ...
                                            <div class="primary_input mb-35">
                                                ...
                                                <select class="primary_select"
                                                        data-course_id="{{@$course->id}}" name="not_working"  id="not_working">
                                                <option value="Student" {{old('not_working') == 'Student' ? "selected" : ""}}>Student</option>
                                                <option value="Fresh Graduate" {{old('not_working') == 'Fresh Graduate' ? "selected" : ""}}>Fresh Graduate</option>
                                                <option value="Retrenched" {{old('not_working') == 'Retrenched' ? "selected" : ""}}>Retrenched</option>
                                                <option value="Retired" {{old('not_working') == 'Retired' ? "selected" : ""}}>Retired</option>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <select class="primary_select sectoredit"
                                                    name="sector">
                                                <option value="Manufacturing" {{old('sector') == 'Manufacturing' ? "selected" : ""}}>Manufacturing</option>
                                                <option value="Mining and quarrying" {{old('sector') == 'Mining and quarrying' ? "selected" : ""}}>Mining and quarrying</option>
                                                <option value="Construction" {{old('sector') == 'Construction' ? "selected" : ""}}>Construction</option>
                                            ...
                                            <br/>
                                                    <div id="sector_otheredit" <?php if(old('sector') == 'Others'){ ?> style="display:block" <?php }else{ ?>
                                                        style="display:none" <?php
                                                    } ?>>
                                                     <label class="primary_input_label" for="">Sector Others
                                                    <strong
                                                        class="text-danger">*</strong></label>
                                                <div class="input-group mb-2 mr-sm-2">
                                                    <input type="text" class="form-control primary_input_field" id="sector_otherinput" value="{{old('sector_other')}}" name="sector_other"
                                                    placeholder="Sector Others" {{$errors->first('sector_other') ? 'autofocus' : ''}}>
                                                </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="primary_input mb-35">
                                                    <label>Highest Academic Qualification</label>
                                                     <select class="primary_select"
                                                    name="highest_academic" id="highest_academic" required>
                                               <option value="Primary School" {{old('highest_academic') == 'Primary School' ? "selected" : ""}}>Primary School</option>
                                                <option value="Secondary School" {{old('highest_academic') == 'Secondary School' ? "selected" : ""}}>Secondary School</option>
                                                <option value="SPM/O-Level/SVM/equivalent" {{old('highest_academic') == 'SPM/O-Level/SVM/equivalent' ? "selected" : ""}}>SPM/O-Level/SVM/equivalent</option>
                                                <option value="Bachelor's Degree/equivalent" {{old('highest_academic') == 'Bachelor\'s Degree/equivalent' ? "selected" : ""}}>Bachelor's Degree/equivalent</option>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <select class="primary_select"
                                                        data-course_id="{{@$course->id}}" name="current_residing" id="current_residing" >
                                             <option value="Kuala Lumpur" {{old('current_residing') == 'Kuala Lumpur' ? "selected" : ""}}>Kuala Lumpur</option>
                                                <option value="Selangor" {{old('current_residing') == 'Selangor' ? "selected" : ""}}>Selangor</option>
                                                <option value="Putrajaya" {{old('current_residing') == 'Putrajaya' ? "selected" : ""}}>Putrajaya</option>
                                                <option value="Labuan" {{old('current_residing') == 'Labuan' ? "selected" : ""}}>Labuan</option>
                                                <option value="Sabah"{{old('current_residing') == 'Sabah' ? "selected" : ""}}>Sabah</option>
                                                <option value="Sarawak" {{old('current_residing') == 'Sarawak' ? "selected" : ""}}>Sarawak</option>
                                                <option value="Melaka" {{old('current_residing') == 'Melaka' ? "selected" : ""}}>Melaka</option>
                                                <option value="Kelantan" {{old('current_residing') == 'Kelantan' ? "selected" : ""}}>Kelantan</option>
                                                <option value="Pahang" {{old('current_residing') == 'Pahang' ? "selected" : ""}}>Pahang</option>
                                                <option value="Perak" {{old('current_residing') == 'Perak' ? "selected" : ""}}>Perak</option>
                                                <option value="Pulau Pinang" {{old('current_residing') == 'Pulau Pinang' ? "selected" : ""}}>Pulau Pinang</option>
                                                <option value="Negeri Sembilan" {{old('current_residing') == 'Negeri Sembilan' ? "selected" : ""}}>Negeri Sembilan</option>
                                                <option value="Kedah" {{old('current_residing') == 'Kedah' ? "selected" : ""}}>Kedah</option>
                                                <option value="Perlis" {{old('current_residing') == 'Perlis' ? "selected" : ""}}>Perlis</option>
                                                <option value="Johor" {{old('current_residing') == 'Johor' ? "selected" : ""}}>Johor</option>
                                                <option value="Terengganu" {{old('current_residing') == 'Terengganu' ? "selected" : ""}}>Terengganu</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 ">
                                                ...
                                                <input type="text" class="form-control primary_input_field" id="zipedit" value="{{old('zip')}}" name="zip" onkeypress="javascript:return isNumber(event)"
                                                    placeholder="Postcode" {{$errors->first('zip') ? 'autofocus' : ''}}>
                                        </div>
                                    </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 text-center pt_15">
                                        <div class="d-flex justify-content-center">
                                            <button class="primary-btn semi_large2  fix-gr-bg"
                                                    id="btn_update_student" type="submit"><i
                ...
                <div class="modal fade admin-query" id="impersonateStudent">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('common.Impersonate')}} {{__('student.Student')}} </h4>
                                <button type="button" class="close" data-dismiss="modal"><i
                                        class="ti-close "></i></button>
                            </div>
                ...
                <div class="modal fade admin-query" id="sendEmailStudent">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('common.Send Reminder Email')}} {{__('student.Student')}} </h4>
                                <button type="button" class="close" data-dismiss="modal"><i
                                        class="ti-close "></i></button>
                            </div>
                ...
                <div class="modal fade admin-query" id="resetPasswordStudent">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">{{__('common.Reset Password')}} {{__('student.Student')}} </h4>
                                <button type="button" class="close" data-dismiss="modal"><i
                                        class="ti-close "></i></button>
                            </div>
                            ...
                            <div class="modal-body">
                                <form action="{{route('student.notify')}}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <textarea class="primary_input_field form-control" name="notification" placeholder="Add Content" style="min-height: 150px;"></textarea>
                                        </div>
                                    </div>
                                    <div class="mt-40 d-flex justify-content-between">
                                        <button type="button" class="primary-btn tr-bg"
    ...
    <script>
        ...
        tableLoad = () => {
            let table = $('#lms_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'citizenship', name: 'citizenship', 'visible' : false},

                    {data: 'identification_number', name: 'identification_number', 'visible' : false},
                    {data: 'job_designation', name: 'job_designation', 'visible' : false},
                    {data: 'sector', name: 'sector', 'visible' : false},
                    {data: 'not_working', name: 'not_working', 'visible' : false},
                    {data: 'business_nature', name: 'business_nature', 'visible' : false},
                    {data: 'business_nature_other', name: 'business_nature_other', 'visible' : false},
                    ...
                    {data: 'race', name: 'race', 'visible' : false},
                    {data: 'employment_status', name: 'employment_status', 'visible' : false},
                    {data: 'highest_academic', name: 'highest_academic', 'visible' : false},
                    {data: 'current_residing', name: 'current_residing', 'visible' : false},
                    // {data: 'zip', name: 'zip', 'visible' : false},
        ...
        $('#filter_employment_status').change(function(){
            if($(this).val() == 'working'){
                ...
                $('#business_nature_div').attr('selectedIndex', '-1').find("option:selected").removeAttr("selected");
                ...
                $('#job_designation_div').attr('selectedIndex', '-1').find("option:selected").removeAttr("selected");
        ...
        $('#excel_import_table_data').click(function () {
            ...
            //           var file = new Blob([response], {type: 'xlsx'});
            //           dlbtn.href = URL.createObjectURL(file);
            //           dlbtn.download = 'myfile.xlsx';
            //           $( "#mine").click();
            //         }, 2000);
            //     }
            // });
