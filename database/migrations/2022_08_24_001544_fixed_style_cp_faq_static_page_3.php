...
class FixedStyleCpFaqStaticPage3 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    <div class="cp-faq-container">
        <div class="cp-faq-page-1">
            <div class="cp-faq-body-container">
                <h2>Getting Started – General</h2><br>
        ...
        <div class="cp-faq-page-2">
            <div class="container-nav-2">
                <h2 style="color: #1a1a64">Become a Content Provider (CP) on e-LATiH</h2><br>
            ...
            <div class="container-nav-3">
                <div class="container-nav-2">
                    <h2 style="color: #1a1a64">Courses</h2><br>
                    <div class="cp-faq-body-content" style="margin-left: 25px;">
            ...
            <div class="cp-faq-nav-4">
                <div class="cp-faq-page-2">
                    <div class="container-nav-2">
                        <h2 style="color: #1a1a64">Content Provider Payments</h2><br>
                        <div class="cp-faq-body-content" style="margin-left: 25px;">
            ...
            <div class="cp-faq-nav-5">
                <div class="cp-faq-page-2">
                    <div class="container-nav-2">
                        <h2 style="color: #1a1a64">Support</h2><br>
                        <div class="cp-faq-body-content" style="margin-left: 25px;">
