<div class="header_iner d-flex justify-content-between align-items-center">
    ...
    <div class="category_search d-flex category_box_iner">
        ...
        <div class="input-group-prepend2">
            <a href="#" class="categories_menu" style="display:none;">
                <i class="fas fa-th"></i>
                {{__('courses.Category')}}
            </a>
            ...
            <ul>
                <li class="position-relative">
                    <a href="#" class="show_notify">
                        <div class="notify_icon">
                            <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/bell.svg" alt="">
                            {{-- <i class="ti-bell"></i> --}}
                        </div>
                        <span class="notify_count" id="notification_count">{{Auth::user()->unreadNotifications->count()}}</span>
                    </a>
                    <div class="notification_menu">
                        <ul>
                            @foreach (Auth::user()->unreadNotifications as $notification)
                                ...
                                <li>
                                    <a href="{{route('myNotification')}}" class="unread_notification" title="Mark As Read" data-notification_id="{{$notification->id}}"> {{ \Illuminate\Support\Str::limit($notification->data['title'], 70, $end='...') }} </a>
                                </li>
                            @endforeach
                ...
                <li>
                    <a href="{{route('myWishlists')}}">
                        <div class="notify_icon">
                            <img src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/heart.svg" alt="">
                        </div>
                        <span class="notify_count" id="bookmark_count">{{@totalWhiteList()}}</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="cart_store">
                        <div class="notify_icon">
                            <img class="" src="{{asset('/public/frontend/elatihlmstheme/')}}/img/svg/cart.svg" alt="">
                        </div>
