                ...
                <div class="col-lg-12">
                    <div class="row pt-20">
                        <ul class="nav nav-tabs no-bottom-border  mt-sm-md-20 mb-30 ml-3" role="tablist">
                            ...
                            <li class="nav-item m-1">
                                <a class="nav-link @if(Session::has('cron')) active @endif"
                                   href="#Cron"
                                   role="tab" data-toggle="tab">{{__('common.Monthly Payment Statement')}}</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                                ...
                                <form
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="">HRD CORP REVENUE PERCENTAGE OF COURSE FEE</label>
                                                <input class="primary_input_field" max="100"
                                                       value="{{@(int)$hrdc_commission}}"
                                                       name="hrdc_commission" placeholder="Admin Commission(%)"
                                                       oninput="calCommission()"
                                                       id="hrdc_commission" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="">Cut Off Date</label>
                                                <input class="primary_input_field" value="{{@(int)$cut_off_date}}"
                                ...
                                <form
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="">{{ __('common.Select') }} {{ __('courses.Trainer') }}</label>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                       for="">HRDC Revenue percentage of course fee</label>
                                                <input class="primary_input_field"
                                                       name="hrdc_commission" id="hrdc_commission"
                                                       placeholder="HRDC Commission(%)"
                                                       type="number" min="0" required>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table Crm_table_active3">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col"> {{__('courses.Trainer Commission')}} </th>
                                                        <th scope="col"> {{__('courses.Admin Commission')}} </th>
                                                        <th scope="col"> HRDC Commission </th>
                                                ...
                                                @foreach ($instructors as $key => $instructor)
                                                    @php
                                                        $admin_commission = 100 - ($instructor->special_commission + $instructor->hrdc_commission);
                                                        $hrdc_commission=$instructor->hrdc_commission;
                                                    @endphp
                                                    <tr>
                                                        <th>{{ $key + 1 }}</th>
                                                        ...
                                                        <td class="nowrap">{{ @$hrdc_commission }}</td>
                                                                    ...
                                                                    <form action="{{route('instructor_commission')}}"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xl-12">
                                                                                <div class="primary_input mb-25">
                                                                                    <label class="primary_input_label"
                                                                                           for="">{{ __('courses.Trainer Commission Percentage') }}</label>
                                        ...
                                        <div class="">
                                            <table id="lms_table" class="table Crm_table_active3">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col"> {{__('courses.Trainer Revenue')}} </th>
                                                    <th scope="col"> {{__('courses.Admin Revenue')}} </th>
                                                    <th scope="col"> HRDC Revenue </th>
                                                ...
                                                @foreach ($courses as $key => $course)
                                                    {{-- @dd($instructor->name) --}}
                                                    @php
                                                        $admin_commission = 100 - ($course->special_commission + $course->hrdc_commission);
                                                        $hrdc_commission = $course->hrdc_commission;
                                                    @endphp
                                                    <tr>
                                                        <th>{{ $key + 1 }}</th>
                                                        <td class="nowrap">
                        ...
                        <div class="tab-pane fade" id="Cron" role="tabpanel" aria-labelledby="General-tab">
                            <div class="white_box_30px">
                                <div class="main-title mb-25">
                                    <h3 class="mb-0">{{ __('common.Monthly Payment Statement') }}</h3>
                                </div>
                                <div class="row">
                                    <div class="col-12 mb-10 pt_15">
                                        <div class="submit_btn text-center">
                                            <button class="primary_btn_large"
                                                    data-toggle="modal"
                                                    data-target="#cronConfirm">
                                                {{ __('common.Calculate') }}
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="modal fade admin-query"
                            ...
                            <div class="modal-dialog modal_800px modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">{{ __('common.Confirm') }} {{ __('common.Run') }} </h4>
                                        <button type="button" class="close "
                                                data-dismiss="modal">
                                            <i class="ti-close "></i>
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        <p>There it will run payment calculation for cp and partner</p>
                                        <form
                                            action="{{ route('admin.callPayoutCron') }}"
                                            method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-12 text-center pt_15">
