...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/elatihlmstheme') }}/css/fluidplayer.min.css?{{ $version }}">
    ...
    <script src="{{asset('public/js/common.js')}}?{{ $version }}"></script>
    <script src="{{asset('public/frontend/elatihlmstheme/js/app.js')}}?{{ $version }}"></script>
    @yield('css')
</head>
...
<script src="{{ asset('public/frontend/elatihlmstheme') }}/js/fluidplayer.min.js"></script>
