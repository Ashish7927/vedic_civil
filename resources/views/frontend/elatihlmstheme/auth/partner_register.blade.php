    ...
    <div class="login_wrapper" style="overflow-y: hidden; ">
        <div class="login_wrapper_left" style="height:1000px;overflow-y: hidden; ">
            ...
            <div class="login_wrapper_content">
                ...
                {{-- <div class="login-text">Please use your MYCO_ID credentials to login with the form below. </div> --}}
                ...
                <form method="POST" id="msform" action="{{route('register_partner')}}">
                    @csrf
                    <input type="hidden" name="role_id" value="8">
                    <div class="row form_row_div">
                        <fieldset style="width: 100%;">
                                ...
                                <div class="col-12 mt_20">
                                    <div class="input-group custom_group_field">
                                        <input type="email" class="form-control pl-0"
                                               placeholder="{{__('common.Enter Email')}} *" aria-label="email" name="email" value="{{ $register->email ?? old('email') }}" autocomplete="off">
                                    </div>
                                ...
                                <div class="col-12 mt_20">
                                    <div class="input-group custom_group_field">
                                        <input type="email" class="form-control pl-0"
                                               ...
                                               value="{{ $register->email ?? old('email_confirmation') }}" autocomplete="off">
                                    </div>
                            ...
                            <div class="col-12">
                                <button type="submit" class="action-button" id="submit_cp">
                                    <span class="submit_btn_text">Register</span>
