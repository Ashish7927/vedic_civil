...
class UpdateEmailTemplateContentAddNewCouce extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $template1->status = 1;
        $body['url'] = url('/');
        $template1->email_body = $this->htmlPart1($subject, $body);
        $template1->save();
    }
    ...
    public function htmlPart1($subject, $body)
    {
        $html = '
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css">
            <style>
