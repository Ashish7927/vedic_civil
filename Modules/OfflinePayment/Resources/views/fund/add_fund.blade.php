                    ...
                    <div class="row student-details student-details_tab mt_0_sm m-0">
                        ...
                        <div class="col-lg-12 p-0">
                            <ul class="nav nav-tabs no-bottom-border mt_0_sm mb-20 m-0 justify-content-start"
                                ...
                                <li class="nav-item mb-0" id="student_li">
                                    <a class="nav-link
                                    @if(Session::has('isStudent'))
                                    @if(Session::get('isStudent'))
                                        active
                                    ...
                                    @endif
                                       ...
                                       data-toggle="tab" id="tab_student">{{__('quiz.Student')}}</a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                @endif" id="group_email_sms">
                                    ...
                                    <div class="QA_section QA_section_heading_custom check_box_table mt-20">
                                        <div class="QA_table ">
                                            <table id="instructor_table" class="table Crm_table_active3">
                                                <thead>
                                                <tr>
                                                    ...
                                                    <tr id="{{ @$value->id}}">
                                                        ...
                                                        <td valign="top">
                                                            <div class="profile_info">
                                                                ...
                                                                <img
                                                                    alt="{{@$value->name}}"
                                                                    src="{{ @$value->image ? asset(@$value->image) :asset('frontend/img/client_img.png') }}"
                                ...
                                @endif
                                    ...
                                    <div class="QA_section QA_section_heading_custom check_box_table mt-20">
                                        <div class="QA_table ">
                                            <!-- table-responsive -->
                                            <table id="student_table" class="table Crm_table_active3">
                                                <thead>
                                                <tr>
                                                    <th>{{__('common.Name')}}</th>
                                                    <th>{{__('common.Email')}}</th>
...
@push('scripts')
    @php
        $url = route('offlinePayment.getInstructorData');
        $url_2 = route('offlinePayment.getStudentData');
    @endphp
    <script>
        var isClicked = 0;
        let table = $('#instructor_table').DataTable({
            bLengthChange: false,
            "bDestroy": true,
            responsive: true,
            processing: true,
        ...
        $('#student_li').on("click", function(e) {
            if(isClicked == 0)
            {
                let table2 = $('#student_table').DataTable({
                    bLengthChange: false,
                    "bDestroy": true,
                    responsive: true,
                    processing: true,
