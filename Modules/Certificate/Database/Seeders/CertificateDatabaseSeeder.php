...
class CertificateDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $certificate->image = 'demo/certificate/certificate.png';
        ...
        $certificate->signature = 'demo/certificate/sign.png';
        ...
        $certificate = new Certificate();
        $certificate->image = 'demo/certificate/certificate1.png';
        ...
        $certificate->save();
         ...
         $certificate->title = 'Certificate For Passed  The Live Class';
         $certificate->title_position_x = 0;
         $certificate->title_position_y = 0;
         $certificate->title_font_family = 'nunito';
         $certificate->title_font_size = 30;
         ...
         $certificate->body = 'This Certificate is awarded to [name]. For successfully complete [course] Live Class';
         $certificate->body_position_x = 0;
         $certificate->body_position_y = 0;
         $certificate->body_font_family = 'nunito';
         $certificate->body_font_size = 25;
