...
@section('title'){{Settings('site_title')  ? Settings('site_title')  : 'e-Latih LMS'}} |   {{$instructor->name}} @endsection
@section('css')
    <style>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="package_widget mb_30">
                                    ...
                                    <div class="package_body">
                                        ...
                                        @endif
                                        <div class="package_footer d-flex justify-content-between align-items-center flex-column">
                                            <div class="prise_tag">
                                                <h4>
                                                    <span>
                                                        {{ getPriceFormat($oldPrice) }}
                                                    </span>
                                                    {{ getPriceFormat($value->price) }}
                                                </h4>
                                                <p>
                                                    {{__('bundleSubscription.Total')}} {{count($value->course)}} {{__('bundleSubscription.Course')}}
                                                </p>
                                            </div>
