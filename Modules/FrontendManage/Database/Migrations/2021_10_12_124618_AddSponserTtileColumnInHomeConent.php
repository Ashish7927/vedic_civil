    ...
    public function up()
    {
        Schema::table('home_contents', function ($table) {
            ...
            if (!Schema::hasColumn('home_contents', 'contact_page_phone')) {
                $table->string('contact_page_phone')->default('frontend/edume/img/lms_cat/1.png');
            }
            if (!Schema::hasColumn('home_contents', 'contact_page_email')) {
                $table->string('contact_page_email')->default('frontend/edume/img/lms_cat/2.png');
            }

            if (!Schema::hasColumn('home_contents', 'contact_page_address')) {
                $table->string('contact_page_address')->default('frontend/edume/img/lms_cat/3.png');
            }
