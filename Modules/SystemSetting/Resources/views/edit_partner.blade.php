<div class="modal-dialog modal_1000px modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">{{__('common.Edit')}} {{__('common.Partner')}}</h4>
            <button type="button" class="close " data-dismiss="modal">
                <i class="ti-close "></i>
            </button>
        </div>
        <div class="modal-body">
                <form action="{{route('update_partner_user',['id'=>$id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="name" value="{{@$partners->name}}"  id="name" placeholder="" required type="text" {{$errors->first('name') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                <label class="primary_input_label" for="email_address">Email {{__('common.Address')}} </label>
                                <input class="primary_input_field" name="email" value="{{@$partners->email}}" id="email_address" placeholder="" required type="text" {{$errors->first('email') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                        ...
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="brand_name" value="{{@$partners->brand_name}}" id="brand_name" placeholder="" type="text" {{$errors->first('brand_name') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                        ...
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="address" value="{{@$partners->address}}" id="address" placeholder="" required type="text" {{$errors->first('address') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="address2" value="{{@$partners->address2}}" id="address2" placeholder="" type="text" {{$errors->first('address2') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="zip" value="{{@$partners->zip }}" id="zip" placeholder="-" type="text">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="city_text" value="{{@$partners->city_text}}" id="city_text" placeholder="" required type="text" {{$errors->first('city_text') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <textarea id="company_profile_summary" name="company_profile_summary" class="primary_textarea"> {{@$partners->company_profile_summary}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="account_holder_name" value="{{@$partners->account_holder_name}}" id="account_holder_name" placeholder="" required type="text" {{$errors->first('account_holder_name') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="bank_account_number" value="{{@$partners->bank_account_number}}" id="bank_account_number" placeholder="" required type="text" {{$errors->first('bank_account_number') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" name="bank_name" value="{{@$partners->bank_name}}" id="bank_name" placeholder="" required type="text" {{$errors->first('bank_name') ? 'autofocus' : ''}}>
                            </div>
                        </div>
                        <div class="col-md-12 mt_20">
                            <div class="remember_forgot_passs d-flex align-items-center">
                                <label class="primary_checkbox d-flex" for="checkbox" style="flex: none; width: 100%; height: auto; margin-bottom: 0.5rem;">
                                    <input name="checkbox" type="checkbox" id="checkbox" {{ ($partners->agreed_to_terms == 1) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 mt_20">
                            <div class="remember_forgot_passs d-flex align-items-center">
                                <label class="primary_checkbox d-flex" for="checkbox1" style="flex: none; width: 100%; height: auto; margin-bottom: 0.5rem;">
                                    <input name="checkbox1" type="checkbox" id="checkbox1" {{ ($partners->agreed_to_terms == 1) ? 'checked' : '' }}>
