...
class ClassPageSection extends Component
{
    ...
    public function render()
    {
        ...
        $total = $courses->total();
        return view(theme('components.class-page-section'), compact('order', 'category', 'level', 'mode', 'order', 'language', 'type', 'total', 'courses', 'rate', 'duration', 'content_provider', 'startprice', 'endprice', 'startDuration', 'endDuration', 'cpdata', 'version'));
    }
}
