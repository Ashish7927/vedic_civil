    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>Not Verified Partner {{__('common.List')}} </h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">{{__('dashboard.Dashboard')}}</a>
                    <a href="#">Partner</a>
                    <a href="#">Not Verified Partner {{__('common.List')}}</a>
                </div>
            </div>
        </div>
    </section>
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <div class="row justify-content-center">
                <div class="modal fade admin-query" id="editPartner">

                </div>
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">Not Verified Partner {{__('common.List')}}</h3>
                        </div>
                ...
                <div class="modal fade admin-query" id="delete_partner_btn">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <form action="{{route('delete_partner')}}" method="POST">
                                @csrf
                                <div class="modal-header">
                                    <h4 class="modal-title">{{__('common.Reject')}} {{__('common.Partner')}} </h4>
                                    <button type="button" class="close" data-dismiss="modal"><i
                                            class="ti-close "></i></button>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="text-center">
                                        ...
                                        <h4>{{__('common.Are you sure to reject ?')}}</h4>
                                    </div>
                                    <input type="hidden" name="id" value="" id="partnerDeleteId">
...
@push('scripts')
    ...
    @php
        $url = route('not_verified_partner_data');
    @endphp
    ...
    <script>
        ...
        $(document).on("click", ".approve_instructor_btn", function() {
            ...
            var url = "{{ route('verify_partner',':id') }}";
        ...
        $(document).on('click', '.delete_partner_btn', function () {
            let id = $(this).data('id');
            $('#partnerDeleteId').val(id);
            $("#delete_partner_btn").modal('show');
        })
        ...
        $(document).on("click", "#send_mail", function() {
            var url = "{{ route('send_mail_to_partner') }}";
