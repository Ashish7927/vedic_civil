            ...
            <div class="row align-items-center pt-3">
                <div class="col-lg-12 ">
                    <div class="cat_welcome_text mb_20">
                        ...
                        <p>{{@$date}}</p>
							{{--   <p style="color:#F6491E;font-weight:bold;">Your completed courses history will be available starting 1 March 2022.</p> --}}
                    </div>
                </div>
                <div class="{{Settings('student_dashboard_card_view')==0?'col-lg-6':'col-lg-9'}} ">
					...
					<a href="{{route('myCourses')}}?category=&cource=progress">
                            <div class="card">
                                <h4 class="pb-0 mb-0">
                                    {{$total['process']}}
                            ...
                            <a href="{{route('myCourses')}}?category=&cource=complete">
                ...
                @if($mycourse)
                    @foreach($mycourse as $key=>$single_course)
                        @if($key<1)
                            ...
                            @endphp
                            <div class="modal" tabindex="-1" id="learnerActivationCourses">
                                    ...
                                    <div class="modal-content">
                                        <form action="{{route('learnerActivationCourse')}}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" name="id" value="" id="learnerActivationCoursesId">
                            ...
                            <div class="dashboard_banner">
                                ...
                                <div class="banner_info">
                                    <input type="hidden" value="{{$single_course->id}}" name="get_single_course_id" id="get_single_course_id"/>
                                    <h4>
                                        @if($single_course->status == 1)
...
<script type="text/javascript">
    $('a[href="#activation-courses"]').click(function(){
        let id = $(this).closest("div.banner_info").find("input[name=get_single_course_id]").val();
        $('#learnerActivationCoursesId').val(id);
        $("#learnerActivationCourses").modal('show');
    });
</script>
