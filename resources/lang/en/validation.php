<?php return array (
  ...
  'email.same' => 'Please Confirm Email Id',
  'password.regex' => 'minimum 8 charaters including 1 capital letters and 1 unique symbol',
  'email_confirmation.same' => 'The email must be same',
  ...
  'race.required' => 'The race filed is required',
  ...
  'student.required' => 'The Learner field is required.',
  ...
  'students.required' => 'Learners is required',
  ...
  'student_type.required' => 'Learner Type is required',
  ...
  'min.string' => 'The password must be at least 8 characters.',
  'same' => 'New password mismatch.',
  'identification_number.min' => 'The NRIC Number should be 12 Digit.',
  'identification_number.max' => 'The NRIC Number should be 12 Digit.',
  'package_courses.required' => 'The package course field is required.',
  'expiry_period.required' => 'The expiry period field is required.',
  'price.required' => 'The price field is required.',
  'email_address.required' => 'The Email  field is required.',
  'phone_number.required' => 'The Phone Number field is required.',
  'company_name.required' => 'The Company Name field is required.',
  'company_registration.required' => 'The Company Registration Number field is required.',
  'terms.required' => 'Please agree to the terms & conditions.',
  'overview.required' => 'The package overview field is required.',
  'total_course.required' => 'The total number of course field is required.',
  'course_url.required' => 'The course url field is required.',
  'course_url.url' => 'Please enter a valid course url.',
  'category_ids.required' => 'The skill area field is required.',
  'max_license_no.gte' => 'Maximum number of license should be greater than or equal to minimum number of license.',
);
