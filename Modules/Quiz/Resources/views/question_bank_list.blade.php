...
@section('mainContent')
<style>
    .QA_table tbody span{ font-family: Poppins,sans-serif !important;
                            ...
                            <div class="">
                                <table id="lms_table" class="table Crm_table_active3">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{__('quiz.Image')}}</th>
                                        <th>{{__('quiz.Question Feedback')}}</th>
        ...
        tableLoad = () => {
            let table = $('#lms_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'question_feedback', name: 'question_feedback', orderable: false,  "render": function (data, type, row) {
                        if (row.enable_question_feedback == 1) {
                            return data;
                        } else {
                            return '';
                        }
