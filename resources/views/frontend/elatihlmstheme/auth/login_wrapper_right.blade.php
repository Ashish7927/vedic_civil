...
<div class="login_wrapper_right" style="background-image: url('{{asset($banner??'frontend/elatihlmstheme/img/banner/global.png')}}'); width:874px; background-repeat: no-repeat;">
    <div class="login_main_info">
       <!--  <h4>

            {{$title??'Welcome to e-Latih Learning Management System'}}
        </h4>
       <div class="thumb">
            <img src="{{asset($banner??'frontend/elatihlmstheme/img/banner/global.png')}}" alt="">
        </div>
